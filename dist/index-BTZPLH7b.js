...
`)+`
`+h);const x=v+m+o,S=v+h+a,C=Cv(r,r.VERTEX_SHADER,x),A=Cv(r,r.FRAGMENT_SHADER,S);r.attachShader(g,C),r.attachShader(g,A),t.index0AttributeName!==void 0?r.bindAttribLocation(g,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function M(T){if(n.debug.checkShaderErrors){const U=r.getProgramInfoLog(g).trim(),z=r.getShaderInfoLog(C).trim(),X=r.getShaderInfoLog(A).trim();let $=!0,H=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if($=!1,typeof n.debug.onShaderError=="function")n.debug.onShaderError(r,g,C,A);else{const Y=Rv(r,C,"vertex"),L=Rv(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
...
`,Zh={mobile:{targetCount:1e4,mouseRadius:.5,mouseStrength:.007},tablet:{targetCount:22e3,mouseRadius:.4,mouseStrength:.01},desktop:{targetCount:55e3,mouseRadius:.35,mouseStrength:.014}},aL=2.8,Qh=.18,lL=2.2,Sx=.45,Mx=.03,uL=.028,cL=.88,Ex=.006,Tx=.5;function fL(){const n=Li.useRef(null),e=Li.useRef(null);return Li.useEffect(()=>{const t=n.current;if(!t||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const r=window.innerWidth,s=window.innerHeight,o=r<=768?Zh.mobile:r<=1024?Zh.tablet:Zh.desktop,a=o.mouseRadius,l=o.mouseStrength,u=a*a,c=document.createElement("canvas");t.appendChild(c);const d=new _b({canvas:c,antialias:!1,alpha:!1,powerPreference:"high-performance"}),f=Math.min(window.devicePixelRatio,2);d.setPixelRatio(f),d.setSize(r,s),d.setClearColor(0,1);const p=new gb,_=new Ni(70,r/s,.001,100);_.position.set(0,-.04,Qh);let g=null,m=null,h=null,v=0,x=null,S=null,C=null,A=null,M=null,R=null,I=0,y=0,T=0,U=0,z=!1,X=0,$=performance.now();je.create({trigger:t,start:"top top",end:"+=2400",pin:!0,pinSpacing:!0,onUpdate(B){I=B.progress}});let H=!1;const Y=new Image;Y.onload=()=>{if(H)return;const B=rL({img:Y,targetCount:o.targetCount,imageScale:aL});v=B.count,x=B.origX,S=B.origY,C=B.depths,A=new Float32Array(v*3),M=new Float32Array(v),R=new Float32Array(v);for(let se=0;se<v;se++)A[se*3]=x[se],A[se*3+1]=S[se],A[se*3+2]=C[se]*Sx;m=new Zr;const Q=new Mi(A,3);Q.setUsage(eA),m.setAttribute("position",Q),m.setAttribute("aColor",new Mi(B.colors,3)),m.setAttribute("aSize",new Mi(B.sizes,1)),h=new qr({vertexShader:sL,fragmentShader:oL,uniforms:{uPixelRatio:{value:f},uOpacity:{value:.65}},transparent:!0,blending:Yp,depthWrite:!1,depthTest:!1}),g=new xb(m,h),p.add(g),$=performance.now(),e.current=requestAnimationFrame(L)},Y.onerror=()=>{console.warn("[ParticleHero] Could not load /deepak-hero-particles.png — place the image in the /public folder and reload.")},Y.src="/deepak-hero-particles.png";function L(){e.current=requestAnimationFrame(L);const B=performance.now(),Q=Math.min((B-$)/16.667,4);$=B,X+=Q*.016,y+=(I-y)*.09;const se=y,ae=Math.min(I/.6,1),Ce=Qh+ae*(lL-Qh),Te=(1-ae)*-.04;_.position.z+=(Ce-_.position.z)*.18*Q,_.position.y+=(Te-_.position.y)*.18*Q,g&&(g.rotation.x+=((1-ae)*.055-g.rotation.x)*.1*Q);const qe=Math.max(0,1-se*1.3)*Sx;if(h&&(h.uniforms.uOpacity.value+=(.62+se*.38-h.uniforms.uOpacity.value)*.05*Q),!v||!A||!m){d.render(p,_);return}const We=_.fov*Math.PI/180,Fe=_.position.z,D=2*Math.tan(We/2)*Fe,rt=D*_.aspect,ke=T*(rt*.5),Ve=U*(D*.5),k=Math.pow(cL,Q);for(let Ue=0;Ue<v;Ue++){const Ae=Ue*3,b=A[Ae],E=A[Ae+1],G=A[Ae+2],J=x[Ue],ie=S[Ue],Z=C[Ue]*qe,Se=C[Ue]*6.2832,oe=Math.sin(X*Tx+Se)*Ex,he=Math.cos(X*Tx*.73+Se*1.31)*Ex;let Ge=0,re=0;if(z){const me=b-ke,Ye=E-Ve,Ne=me*me+Ye*Ye;if(Ne<u&&Ne>1e-8){const Je=Math.sqrt(Ne),N=(1-Je/a)*l*Q;Ge=me/Je*N,re=Ye/Je*N}}const xe=(J+oe-b)*Mx*Q,Me=(ie+he-E)*Mx*Q,Oe=(Z-G)*uL*Q;M[Ue]=(M[Ue]+xe+Ge)*k,R[Ue]=(R[Ue]+Me+re)*k,A[Ae]=b+M[Ue],A[Ae+1]=E+R[Ue],A[Ae+2]=G+Oe}m.attributes.position.needsUpdate=!0,d.render(p,_)}const j=B=>{T=B.clientX/window.innerWidth*2-1,U=-(B.clientY/window.innerHeight)*2+1,z=!0},P=()=>{z=!1},te=B=>{B.touches.length&&(T=B.touches[0].clientX/window.innerWidth*2-1,U=-(B.touches[0].clientY/window.innerHeight)*2+1,z=!0)},ye=()=>{z=!1},He=()=>{const B=window.innerWidth,Q=window.innerHeight;_.aspect=B/Q,_.updateProjectionMatrix(),d.setSize(B,Q),h&&(h.uniforms.uPixelRatio.value=d.getPixelRatio())};return window.addEventListener("mousemove",j,{passive:!0}),window.addEventListener("mouseleave",P),window.addEventListener("touchmove",te,{passive:!0}),window.addEventListener("touchend",ye,{passive:!0}),window.addEventListener("resize",He),()=>{H=!0,cancelAnimationFrame(e.current),window.removeEventListener("mousemove",j),window.removeEventListener("mouseleave",P),window.removeEventListener("touchmove",te),window.removeEventListener("touchend",ye),window.removeEventListener("resize",He),je.getAll().forEach(B=>B.kill()),m==null||m.dispose(),h==null||h.dispose(),d.dispose(),c.parentNode&&c.parentNode.removeChild(c)}},[]),An.jsx("div",{className:"particle-hero",ref:n,children:An.jsx("noscript",{children:An.jsx("img",{src:"/deepak-hero-particles.png",alt:"Deepak Parikh at 60",className:"particle-fallback"})})})}po.registerPlugin(je);function dL(){const n=Li.useRef(null),e=Li.useRef(null),t=Li.useRef(null),i=Li.useRef(null),r=Li.useRef(null);return Li.useEffect(()=>{const s=n.current,o=e.current,a=t.current,l=i.current,u=r.current;if(!s||!o||!a||!l||!u)return;po.set(o,{backgroundColor:"#07070f"}),po.set(a,{opacity:0,scale:.8}),po.set([l,u],{opacity:0,y:32,filter:"blur(10px)"});const c=po.timeline();c.fromTo(o,{backgroundColor:"#07070f"},{backgroundColor:"#F2E6D0",duration:.5,ease:"power1.inOut"},0),c.fromTo(a,{opacity:0,scale:.8},{opacity:1,scale:1,duration:.32,ease:"power2.out"},.3),c.fromTo(l,{opacity:0,y:32,filter:"blur(10px)"},{opacity:1,y:0,filter:"blur(0px)",duration:.2,ease:"power3.out"},.55),c.fromTo(u,{opacity:0,y:32,filter:"blur(10px)"},{opacity:1,y:0,filter:"blur(0px)",duration:.18,ease:"power3.out"},.72),c.to({},{duration:.1},.9);const d=je.create({trigger:s,start:"top top",end:"+=2400",pin:!0,pinSpacing:!0,scrub:.8,animation:c});return()=>{d.kill(),c.kill()}},[]),An.jsxs("section",{className:"timeless-section",ref:n,children:[An.jsx("div",{className:"timeless-bg",ref:e}),An.jsx("div",{className:"timeless-grain","aria-hidden":"true"}),An.jsx("div",{className:"timeless-glow",ref:t,"aria-hidden":"true"}),An.jsx("div",{className:"timeless-quote-wrap",children:An.jsxs("h2",{className:"timeless-quote",children:[An.jsx("span",{ref:i,children:"The deepest roots are never seen,"}),An.jsx("span",{ref:r,children:"but everyone remembers the shade."})]})})]})}function hL(){return An.jsxs("main",{children:[An.jsx(fL,{}),An.jsx(dL,{})]})}Jh.createRoot(document.getElementById("root")).render(An.jsx(e1.StrictMode,{children:An.jsx(hL,{})}));
