...
}`;function tb(n,e,t){let i=new uM;const r=new Tt,s=new Tt,o=new $t,a=new Z2({depthPacking:Ww}),l=new Q2,u={},c=t.maxTextureSize,d={[Us]:Jn,[Jn]:Us,[Dr]:Dr},f=new qr({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Tt},radius:{value:4}},vertexShader:J2,fragmentShader:eb}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const _=new Zr;_.setAttribute("position",new Mi(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new Fr(_,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=FS;let h=this.type;this.render=function(A,M,R){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const I=n.getRenderTarget(),y=n.getActiveCubeFace(),T=n.getActiveMipmapLevel(),U=n.state;U.setBlending(Cs),U.buffers.color.setClear(1,1,1,1),U.buffers.depth.setTest(!0),U.setScissorTest(!1);const z=h!==Ar&&this.type===Ar,X=h===Ar&&this.type!==Ar;for(let $=0,B=A.length;$<B;$++){const Y=A[$],L=Y.shadow;if(L===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const j=L.getFrameExtents();if(r.multiply(j),s.copy(L.mapSize),(r.x>c||r.y>c)&&(r.x>c&&(s.x=Math.floor(c/j.x),r.x=s.x*j.x,L.mapSize.x=s.x),r.y>c&&(s.y=Math.floor(c/j.y),r.y=s.y*j.y,L.mapSize.y=s.y)),L.map===null||z===!0||X===!0){const te=this.type!==Ar?{minFilter:zi,magFilter:zi}:{};L.map!==null&&L.map.dispose(),L.map=new Lo(r.x,r.y,te),L.map.texture.name=Y.name+".shadowMap",L.camera.updateProjectionMatrix()}n.setRenderTarget(L.map),n.clear();const P=L.getViewportCount();for(let te=0;te<P;te++){const ye=L.getViewport(te);o.set(s.x*ye.x,s.y*ye.y,s.x*ye.z,s.y*ye.w),U.viewport(o),L.updateMatrices(Y,te),i=L.getFrustum(),S(M,R,L.camera,Y,this.type)}L.isPointLightShadow!==!0&&this.type===Ar&&v(L,R),L.needsUpdate=!1}h=this.type,m.needsUpdate=!1,n.setRenderTarget(I,y,T)};function v(A,M){const R=e.update(g);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Lo(r.x,r.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,n.setRenderTarget(A.mapPass),n.clear(),n.renderBufferDirect(M,null,R,f,g,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,n.setRenderTarget(A.map),n.clear(),n.renderBufferDirect(M,null,R,p,g,null)}function x(A,M,R,I){let y=null;const T=R.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(T!==void 0)y=T;else if(y=R.isPointLight===!0?l:a,n.localClippingEnabled&&M.clipShadows===!0&&Array.isArray(M.clippingPlanes)&&M.clippingPlanes.length!==0||M.displacementMap&&M.displacementScale!==0||M.alphaMap&&M.alphaTest>0||M.map&&M.alphaTest>0){const U=y.uuid,z=M.uuid;let X=u[U];X===void 0&&(X={},u[U]=X);let $=X[z];$===void 0&&($=y.clone(),X[z]=$,M.addEventListener("dispose",C)),y=$}if(y.visible=M.visible,y.wireframe=M.wireframe,I===Ar?y.side=M.shadowSide!==null?M.shadowSide:M.side:y.side=M.shadowSide!==null?M.shadowSide:d[M.side],y.alphaMap=M.alphaMap,y.alphaTest=M.alphaTest,y.map=M.map,y.clipShadows=M.clipShadows,y.clippingPlanes=M.clippingPlanes,y.clipIntersection=M.clipIntersection,y.displacementMap=M.displacementMap,y.displacementScale=M.displacementScale,y.displacementBias=M.displacementBias,y.wireframeLinewidth=M.wireframeLinewidth,y.linewidth=M.linewidth,R.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const U=n.properties.get(y);U.light=R}return y}function S(A,M,R,I,y){if(A.visible===!1)return;if(A.layers.test(M.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&y===Ar)&&(!A.frustumCulled||i.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,A.matrixWorld);const z=e.update(A),X=A.material;if(Array.isArray(X)){const $=z.groups;for(let B=0,Y=$.length;B<Y;B++){const L=$[B],j=X[L.materialIndex];if(j&&j.visible){const P=x(A,j,I,y);A.onBeforeShadow(n,A,M,R,z,P,L),n.renderBufferDirect(R,null,z,P,A,L),A.onAfterShadow(n,A,M,R,z,P,L)}}}else if(X.visible){const $=x(A,X,I,y);A.onBeforeShadow(n,A,M,R,z,$,null),n.renderBufferDirect(R,null,z,$,A,null),A.onAfterShadow(n,A,M,R,z,$,null)}}const U=A.children;for(let z=0,X=U.length;z<X;z++)S(U[z],M,R,I,y)}function C(A){A.target.removeEventListener("dispose",C);for(const R in u){const I=u[R],y=A.target.uuid;y in I&&(I[y].dispose(),delete I[y])}}}const nb={[jp]:Kp,[Zp]:em,[Qp]:tm,[Ya]:Jp,[Kp]:jp,[em]:Zp,[tm]:Qp,[Jp]:Ya};function ib(n){function e(){let O=!1;const ne=new $t;let K=null;const ee=new $t(0,0,0,0);return{setMask:function(ce){K!==ce&&!O&&(n.colorMask(ce,ce,ce,ce),K=ce)},setLocked:function(ce){O=ce},setClear:function(ce,de,$e,yt,Dt){Dt===!0&&(ce*=yt,de*=yt,$e*=yt),ne.set(ce,de,$e,yt),ee.equals(ne)===!1&&(n.clearColor(ce,de,$e,yt),ee.copy(ne))},reset:function(){O=!1,K=null,ee.set(-1,0,0,0)}}}function t(){let O=!1,ne=!1,K=null,ee=null,ce=null;return{setReversed:function(de){ne=de},setTest:function(de){de?re(n.DEPTH_TEST):le(n.DEPTH_TEST)},setMask:function(de){K!==de&&!O&&(n.depthMask(de),K=de)},setFunc:function(de){if(ne&&(de=nb[de]),ee!==de){switch(de){case jp:n.depthFunc(n.NEVER);break;case Kp:n.depthFunc(n.ALWAYS);break;case Zp:n.depthFunc(n.LESS);break;case Ya:n.depthFunc(n.LEQUAL);break;case Qp:n.depthFunc(n.EQUAL);break;case Jp:n.depthFunc(n.GEQUAL);break;case em:n.depthFunc(n.GREATER);break;case tm:n.depthFunc(n.NOTEQUAL);break;default:n.depthFunc(n.LEQUAL)}ee=de}},setLocked:function(de){O=de},setClear:function(de){ce!==de&&(n.clearDepth(de),ce=de)},reset:function(){O=!1,K=null,ee=null,ce=null}}}function i(){let O=!1,ne=null,K=null,ee=null,ce=null,de=null,$e=null,yt=null,Dt=null;return{setTest:function(st){O||(st?re(n.STENCIL_TEST):le(n.STENCIL_TEST))},setMask:function(st){ne!==st&&!O&&(n.stencilMask(st),ne=st)},setFunc:function(st,De,Ce){(K!==st||ee!==De||ce!==Ce)&&(n.stencilFunc(st,De,Ce),K=st,ee=De,ce=Ce)},setOp:function(st,De,Ce){(de!==st||$e!==De||yt!==Ce)&&(n.stencilOp(st,De,Ce),de=st,$e=De,yt=Ce)},setLocked:function(st){O=st},setClear:function(st){Dt!==st&&(n.clearStencil(st),Dt=st)},reset:function(){O=!1,ne=null,K=null,ee=null,ce=null,de=null,$e=null,yt=null,Dt=null}}}const r=new e,s=new t,o=new i,a=new WeakMap,l=new WeakMap;let u={},c={},d=new WeakMap,f=[],p=null,_=!1,g=null,m=null,h=null,v=null,x=null,S=null,C=null,A=new gt(0,0,0),M=0,R=!1,I=null,y=null,T=null,U=null,z=null;const X=n.getParameter(n.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let $=!1,B=0;const Y=n.getParameter(n.VERSION);Y.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(Y)[1]),$=B>=1):Y.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(Y)[1]),$=B>=2);let L=null,j={};const P=n.getParameter(n.SCISSOR_BOX),te=n.getParameter(n.VIEWPORT),ye=new $t().fromArray(P),Be=new $t().fromArray(te);function H(O,ne,K,ee){const ce=new Uint8Array(4),de=n.createTexture();n.bindTexture(O,de),n.texParameteri(O,n.TEXTURE_MIN_FILTER,n.NEAREST),n.texParameteri(O,n.TEXTURE_MAG_FILTER,n.NEAREST);for(let $e=0;$e<K;$e++)O===n.TEXTURE_3D||O===n.TEXTURE_2D_ARRAY?n.texImage3D(ne,0,n.RGBA,1,1,ee,0,n.RGBA,n.UNSIGNED_BYTE,ce):n.texImage2D(ne+$e,0,n.RGBA,1,1,0,n.RGBA,n.UNSIGNED_BYTE,ce);return de}const Q={};Q[n.TEXTURE_2D]=H(n.TEXTURE_2D,n.TEXTURE_2D,1),Q[n.TEXTURE_CUBE_MAP]=H(n.TEXTURE_CUBE_MAP,n.TEXTURE_CUBE_MAP_POSITIVE_X,6),Q[n.TEXTURE_2D_ARRAY]=H(n.TEXTURE_2D_ARRAY,n.TEXTURE_2D_ARRAY,1,1),Q[n.TEXTURE_3D]=H(n.TEXTURE_3D,n.TEXTURE_3D,1,1),r.setClear(0,0,0,1),s.setClear(1),o.setClear(0),re(n.DEPTH_TEST),s.setFunc(Ya),Fe(!1),He(W0),re(n.CULL_FACE),D(Cs);function re(O){u[O]!==!0&&(n.enable(O),u[O]=!0)}function le(O){u[O]!==!1&&(n.disable(O),u[O]=!1)}function Ae(O,ne){return c[O]!==ne?(n.bindFramebuffer(O,ne),c[O]=ne,O===n.DRAW_FRAMEBUFFER&&(c[n.FRAMEBUFFER]=ne),O===n.FRAMEBUFFER&&(c[n.DRAW_FRAMEBUFFER]=ne),!0):!1}function Te(O,ne){let K=f,ee=!1;if(O){K=d.get(ne),K===void 0&&(K=[],d.set(ne,K));const ce=O.textures;if(K.length!==ce.length||K[0]!==n.COLOR_ATTACHMENT0){for(let de=0,$e=ce.length;de<$e;de++)K[de]=n.COLOR_ATTACHMENT0+de;K.length=ce.length,ee=!0}}else K[0]!==n.BACK&&(K[0]=n.BACK,ee=!0);ee&&n.drawBuffers(K)}function qe(O){return p!==O?(n.useProgram(O),p=O,!0):!1}const Ge={[so]:n.FUNC_ADD,[_w]:n.FUNC_SUBTRACT,[gw]:n.FUNC_REVERSE_SUBTRACT};Ge[vw]=n.MIN,Ge[xw]=n.MAX;const Oe={[yw]:n.ZERO,[Sw]:n.ONE,[Mw]:n.SRC_COLOR,[qp]:n.SRC_ALPHA,[Rw]:n.SRC_ALPHA_SATURATE,[Aw]:n.DST_COLOR,[Tw]:n.DST_ALPHA,[Ew]:n.ONE_MINUS_SRC_COLOR,[$p]:n.ONE_MINUS_SRC_ALPHA,[Cw]:n.ONE_MINUS_DST_COLOR,[ww]:n.ONE_MINUS_DST_ALPHA,[Pw]:n.CONSTANT_COLOR,[bw]:n.ONE_MINUS_CONSTANT_COLOR,[Dw]:n.CONSTANT_ALPHA,[Lw]:n.ONE_MINUS_CONSTANT_ALPHA};function D(O,ne,K,ee,ce,de,$e,yt,Dt,st){if(O===Cs){_===!0&&(le(n.BLEND),_=!1);return}if(_===!1&&(re(n.BLEND),_=!0),O!==mw){if(O!==g||st!==R){if((m!==so||x!==so)&&(n.blendEquation(n.FUNC_ADD),m=so,x=so),st)switch(O){case Pa:n.blendFuncSeparate(n.ONE,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Yp:n.blendFunc(n.ONE,n.ONE);break;case X0:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Y0:n.blendFuncSeparate(n.ZERO,n.SRC_COLOR,n.ZERO,n.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}else switch(O){case Pa:n.blendFuncSeparate(n.SRC_ALPHA,n.ONE_MINUS_SRC_ALPHA,n.ONE,n.ONE_MINUS_SRC_ALPHA);break;case Yp:n.blendFunc(n.SRC_ALPHA,n.ONE);break;case X0:n.blendFuncSeparate(n.ZERO,n.ONE_MINUS_SRC_COLOR,n.ZERO,n.ONE);break;case Y0:n.blendFunc(n.ZERO,n.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",O);break}h=null,v=null,S=null,C=null,A.set(0,0,0),M=0,g=O,R=st}return}ce=ce||ne,de=de||K,$e=$e||ee,(ne!==m||ce!==x)&&(n.blendEquationSeparate(Ge[ne],Ge[ce]),m=ne,x=ce),(K!==h||ee!==v||de!==S||$e!==C)&&(n.blendFuncSeparate(Oe[K],Oe[ee],Oe[de],Oe[$e]),h=K,v=ee,S=de,C=$e),(yt.equals(A)===!1||Dt!==M)&&(n.blendColor(yt.r,yt.g,yt.b,Dt),A.copy(yt),M=Dt),g=O,R=!1}function rt(O,ne){O.side===Dr?le(n.CULL_FACE):re(n.CULL_FACE);let K=O.side===Jn;ne&&(K=!K),Fe(K),O.blending===Pa&&O.transparent===!1?D(Cs):D(O.blending,O.blendEquation,O.blendSrc,O.blendDst,O.blendEquationAlpha,O.blendSrcAlpha,O.blendDstAlpha,O.blendColor,O.blendAlpha,O.premultipliedAlpha),s.setFunc(O.depthFunc),s.setTest(O.depthTest),s.setMask(O.depthWrite),r.setMask(O.colorWrite);const ee=O.stencilWrite;o.setTest(ee),ee&&(o.setMask(O.stencilWriteMask),o.setFunc(O.stencilFunc,O.stencilRef,O.stencilFuncMask),o.setOp(O.stencilFail,O.stencilZFail,O.stencilZPass)),We(O.polygonOffset,O.polygonOffsetFactor,O.polygonOffsetUnits),O.alphaToCoverage===!0?re(n.SAMPLE_ALPHA_TO_COVERAGE):le(n.SAMPLE_ALPHA_TO_COVERAGE)}function Fe(O){I!==O&&(O?n.frontFace(n.CW):n.frontFace(n.CCW),I=O)}function He(O){O!==dw?(re(n.CULL_FACE),O!==y&&(O===W0?n.cullFace(n.BACK):O===hw?n.cullFace(n.FRONT):n.cullFace(n.FRONT_AND_BACK))):le(n.CULL_FACE),y=O}function N(O){O!==T&&($&&n.lineWidth(O),T=O)}function We(O,ne,K){O?(re(n.POLYGON_OFFSET_FILL),(U!==ne||z!==K)&&(n.polygonOffset(ne,K),U=ne,z=K)):le(n.POLYGON_OFFSET_FILL)}function Pe(O){O?re(n.SCISSOR_TEST):le(n.SCISSOR_TEST)}function b(O){O===void 0&&(O=n.TEXTURE0+X-1),L!==O&&(n.activeTexture(O),L=O)}function E(O,ne,K){K===void 0&&(L===null?K=n.TEXTURE0+X-1:K=L);let ee=j[K];ee===void 0&&(ee={type:void 0,texture:void 0},j[K]=ee),(ee.type!==O||ee.texture!==ne)&&(L!==K&&(n.activeTexture(K),L=K),n.bindTexture(O,ne||Q[O]),ee.type=O,ee.texture=ne)}function G(){const O=j[L];O!==void 0&&O.type!==void 0&&(n.bindTexture(O.type,null),O.type=void 0,O.texture=void 0)}function J(){try{n.compressedTexImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function ie(){try{n.compressedTexImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Z(){try{n.texSubImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Me(){try{n.texSubImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function oe(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function fe(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Ve(){try{n.texStorage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function se(){try{n.texStorage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function xe(){try{n.texImage2D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Se(){try{n.texImage3D.apply(n,arguments)}catch(O){console.error("THREE.WebGLState:",O)}}function Ue(O){ye.equals(O)===!1&&(n.scissor(O.x,O.y,O.z,O.w),ye.copy(O))}function me(O){Be.equals(O)===!1&&(n.viewport(O.x,O.y,O.z,O.w),Be.copy(O))}function Ye(O,ne){let K=l.get(ne);K===void 0&&(K=new WeakMap,l.set(ne,K));let ee=K.get(O);ee===void 0&&(ee=n.getUniformBlockIndex(ne,O.name),K.set(O,ee))}function Ne(O,ne){const ee=l.get(ne).get(O);a.get(ne)!==ee&&(n.uniformBlockBinding(ne,ee,O.__bindingPointIndex),a.set(ne,ee))}function tt(){n.disable(n.BLEND),n.disable(n.CULL_FACE),n.disable(n.DEPTH_TEST),n.disable(n.POLYGON_OFFSET_FILL),n.disable(n.SCISSOR_TEST),n.disable(n.STENCIL_TEST),n.disable(n.SAMPLE_ALPHA_TO_COVERAGE),n.blendEquation(n.FUNC_ADD),n.blendFunc(n.ONE,n.ZERO),n.blendFuncSeparate(n.ONE,n.ZERO,n.ONE,n.ZERO),n.blendColor(0,0,0,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(n.LESS),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(n.ALWAYS,0,4294967295),n.stencilOp(n.KEEP,n.KEEP,n.KEEP),n.clearStencil(0),n.cullFace(n.BACK),n.frontFace(n.CCW),n.polygonOffset(0,0),n.activeTexture(n.TEXTURE0),n.bindFramebuffer(n.FRAMEBUFFER,null),n.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),n.bindFramebuffer(n.READ_FRAMEBUFFER,null),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),u={},L=null,j={},c={},d=new WeakMap,f=[],p=null,_=!1,g=null,m=null,h=null,v=null,x=null,S=null,C=null,A=new gt(0,0,0),M=0,R=!1,I=null,y=null,T=null,U=null,z=null,ye.set(0,0,n.canvas.width,n.canvas.height),Be.set(0,0,n.canvas.width,n.canvas.height),r.reset(),s.reset(),o.reset()}return{buffers:{color:r,depth:s,stencil:o},enable:re,disable:le,bindFramebuffer:Ae,drawBuffers:Te,useProgram:qe,setBlending:D,setMaterial:rt,setFlipSided:Fe,setCullFace:He,setLineWidth:N,setPolygonOffset:We,setScissorTest:Pe,activeTexture:b,bindTexture:E,unbindTexture:G,compressedTexImage2D:J,compressedTexImage3D:ie,texImage2D:xe,texImage3D:Se,updateUBOMapping:Ye,uniformBlockBinding:Ne,texStorage2D:Ve,texStorage3D:se,texSubImage2D:Z,texSubImage3D:Me,compressedTexSubImage2D:oe,compressedTexSubImage3D:fe,scissor:Ue,viewport:me,reset:tt}}function Ov(n,e,t,i){const r=rb(i);switch(t){case GS:return n*e;case XS:return n*e;case YS:return n*e*2;case qS:return n*e/r.components*r.byteLength;case ig:return n*e/r.components*r.byteLength;case $S:return n*e*2/r.components*r.byteLength;case rg:return n*e*2/r.components*r.byteLength;case WS:return n*e*3/r.components*r.byteLength;case ir:return n*e*4/r.components*r.byteLength;case sg:return n*e*4/r.components*r.byteLength;case rf:case sf:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case of:case af:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case am:case um:return Math.max(n,16)*Math.max(e,8)/4;case om:case lm:return Math.max(n,8)*Math.max(e,8)/2;case cm:case fm:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*8;case dm:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case hm:return Math.floor((n+3)/4)*Math.floor((e+3)/4)*16;case pm:return Math.floor((n+4)/5)*Math.floor((e+3)/4)*16;case mm:return Math.floor((n+4)/5)*Math.floor((e+4)/5)*16;case _m:return Math.floor((n+5)/6)*Math.floor((e+4)/5)*16;case gm:return Math.floor((n+5)/6)*Math.floor((e+5)/6)*16;case vm:return Math.floor((n+7)/8)*Math.floor((e+4)/5)*16;case xm:return Math.floor((n+7)/8)*Math.floor((e+5)/6)*16;case ym:return Math.floor((n+7)/8)*Math.floor((e+7)/8)*16;case Sm:return Math.floor((n+9)/10)*Math.floor((e+4)/5)*16;case Mm:return Math.floor((n+9)/10)*Math.floor((e+5)/6)*16;case Em:return Math.floor((n+9)/10)*Math.floor((e+7)/8)*16;case Tm:return Math.floor((n+9)/10)*Math.floor((e+9)/10)*16;case wm:return Math.floor((n+11)/12)*Math.floor((e+9)/10)*16;case Am:return Math.floor((n+11)/12)*Math.floor((e+11)/12)*16;case lf:case Cm:case Rm:return Math.ceil(n/4)*Math.ceil(e/4)*16;case jS:case Pm:return Math.ceil(n/4)*Math.ceil(e/4)*8;case bm:case Dm:return Math.ceil(n/4)*Math.ceil(e/4)*16}throw new Error(`Unable to determine texture byte length for ${t} format.`)}function rb(n){switch(n){case Xr:case BS:return{byteLength:1,components:1};case Mu:case HS:case ku:return{byteLength:2,components:1};case tg:case ng:return{byteLength:2,components:4};case Do:case eg:case Nr:return{byteLength:4,components:1};case VS:return{byteLength:4,components:3}}throw new Error(`Unknown texture type ${n}.`)}function sb(n,e,t,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new Tt,c=new WeakMap;let d;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(b,E){return p?new OffscreenCanvas(b,E):$f("canvas")}function g(b,E,G){let J=1;const ie=Pe(b);if((ie.width>G||ie.height>G)&&(J=G/Math.max(ie.width,ie.height)),J<1)if(typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&b instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&b instanceof ImageBitmap||typeof VideoFrame<"u"&&b instanceof VideoFrame){const Z=Math.floor(J*ie.width),Me=Math.floor(J*ie.height);d===void 0&&(d=_(Z,Me));const oe=E?_(Z,Me):d;return oe.width=Z,oe.height=Me,oe.getContext("2d").drawImage(b,0,0,Z,Me),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+ie.width+"x"+ie.height+") to ("+Z+"x"+Me+")."),oe}else return"data"in b&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+ie.width+"x"+ie.height+")."),b;return b}function m(b){return b.generateMipmaps&&b.minFilter!==zi&&b.minFilter!==tr}function h(b){n.generateMipmap(b)}function v(b,E,G,J,ie=!1){if(b!==null){if(n[b]!==void 0)return n[b];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+b+"'")}let Z=E;if(E===n.RED&&(G===n.FLOAT&&(Z=n.R32F),G===n.HALF_FLOAT&&(Z=n.R16F),G===n.UNSIGNED_BYTE&&(Z=n.R8)),E===n.RED_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.R8UI),G===n.UNSIGNED_SHORT&&(Z=n.R16UI),G===n.UNSIGNED_INT&&(Z=n.R32UI),G===n.BYTE&&(Z=n.R8I),G===n.SHORT&&(Z=n.R16I),G===n.INT&&(Z=n.R32I)),E===n.RG&&(G===n.FLOAT&&(Z=n.RG32F),G===n.HALF_FLOAT&&(Z=n.RG16F),G===n.UNSIGNED_BYTE&&(Z=n.RG8)),E===n.RG_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.RG8UI),G===n.UNSIGNED_SHORT&&(Z=n.RG16UI),G===n.UNSIGNED_INT&&(Z=n.RG32UI),G===n.BYTE&&(Z=n.RG8I),G===n.SHORT&&(Z=n.RG16I),G===n.INT&&(Z=n.RG32I)),E===n.RGB_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.RGB8UI),G===n.UNSIGNED_SHORT&&(Z=n.RGB16UI),G===n.UNSIGNED_INT&&(Z=n.RGB32UI),G===n.BYTE&&(Z=n.RGB8I),G===n.SHORT&&(Z=n.RGB16I),G===n.INT&&(Z=n.RGB32I)),E===n.RGBA_INTEGER&&(G===n.UNSIGNED_BYTE&&(Z=n.RGBA8UI),G===n.UNSIGNED_SHORT&&(Z=n.RGBA16UI),G===n.UNSIGNED_INT&&(Z=n.RGBA32UI),G===n.BYTE&&(Z=n.RGBA8I),G===n.SHORT&&(Z=n.RGBA16I),G===n.INT&&(Z=n.RGBA32I)),E===n.RGB&&G===n.UNSIGNED_INT_5_9_9_9_REV&&(Z=n.RGB9_E5),E===n.RGBA){const Me=ie?Wf:pt.getTransfer(J);G===n.FLOAT&&(Z=n.RGBA32F),G===n.HALF_FLOAT&&(Z=n.RGBA16F),G===n.UNSIGNED_BYTE&&(Z=Me===Pt?n.SRGB8_ALPHA8:n.RGBA8),G===n.UNSIGNED_SHORT_4_4_4_4&&(Z=n.RGBA4),G===n.UNSIGNED_SHORT_5_5_5_1&&(Z=n.RGB5_A1)}return(Z===n.R16F||Z===n.R32F||Z===n.RG16F||Z===n.RG32F||Z===n.RGBA16F||Z===n.RGBA32F)&&e.get("EXT_color_buffer_float"),Z}function x(b,E){let G;return b?E===null||E===Do||E===ja?G=n.DEPTH24_STENCIL8:E===Nr?G=n.DEPTH32F_STENCIL8:E===Mu&&(G=n.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):E===null||E===Do||E===ja?G=n.DEPTH_COMPONENT24:E===Nr?G=n.DEPTH_COMPONENT32F:E===Mu&&(G=n.DEPTH_COMPONENT16),G}function S(b,E){return m(b)===!0||b.isFramebufferTexture&&b.minFilter!==zi&&b.minFilter!==tr?Math.log2(Math.max(E.width,E.height))+1:b.mipmaps!==void 0&&b.mipmaps.length>0?b.mipmaps.length:b.isCompressedTexture&&Array.isArray(b.image)?E.mipmaps.length:1}function C(b){const E=b.target;E.removeEventListener("dispose",C),M(E),E.isVideoTexture&&c.delete(E)}function A(b){const E=b.target;E.removeEventListener("dispose",A),I(E)}function M(b){const E=i.get(b);if(E.__webglInit===void 0)return;const G=b.source,J=f.get(G);if(J){const ie=J[E.__cacheKey];ie.usedTimes--,ie.usedTimes===0&&R(b),Object.keys(J).length===0&&f.delete(G)}i.remove(b)}function R(b){const E=i.get(b);n.deleteTexture(E.__webglTexture);const G=b.source,J=f.get(G);delete J[E.__cacheKey],o.memory.textures--}function I(b){const E=i.get(b);if(b.depthTexture&&b.depthTexture.dispose(),b.isWebGLCubeRenderTarget)for(let J=0;J<6;J++){if(Array.isArray(E.__webglFramebuffer[J]))for(let ie=0;ie<E.__webglFramebuffer[J].length;ie++)n.deleteFramebuffer(E.__webglFramebuffer[J][ie]);else n.deleteFramebuffer(E.__webglFramebuffer[J]);E.__webglDepthbuffer&&n.deleteRenderbuffer(E.__webglDepthbuffer[J])}else{if(Array.isArray(E.__webglFramebuffer))for(let J=0;J<E.__webglFramebuffer.length;J++)n.deleteFramebuffer(E.__webglFramebuffer[J]);else n.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&n.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&n.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let J=0;J<E.__webglColorRenderbuffer.length;J++)E.__webglColorRenderbuffer[J]&&n.deleteRenderbuffer(E.__webglColorRenderbuffer[J]);E.__webglDepthRenderbuffer&&n.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const G=b.textures;for(let J=0,ie=G.length;J<ie;J++){const Z=i.get(G[J]);Z.__webglTexture&&(n.deleteTexture(Z.__webglTexture),o.memory.textures--),i.remove(G[J])}i.remove(b)}let y=0;function T(){y=0}function U(){const b=y;return b>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+b+" texture units while this GPU supports only "+r.maxTextures),y+=1,b}function z(b){const E=[];return E.push(b.wrapS),E.push(b.wrapT),E.push(b.wrapR||0),E.push(b.magFilter),E.push(b.minFilter),E.push(b.anisotropy),E.push(b.internalFormat),E.push(b.format),E.push(b.type),E.push(b.generateMipmaps),E.push(b.premultiplyAlpha),E.push(b.flipY),E.push(b.unpackAlignment),E.push(b.colorSpace),E.join()}function X(b,E){const G=i.get(b);if(b.isVideoTexture&&N(b),b.isRenderTargetTexture===!1&&b.version>0&&G.__version!==b.version){const J=b.image;if(J===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(J.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Be(G,b,E);return}}t.bindTexture(n.TEXTURE_2D,G.__webglTexture,n.TEXTURE0+E)}function $(b,E){const G=i.get(b);if(b.version>0&&G.__version!==b.version){Be(G,b,E);return}t.bindTexture(n.TEXTURE_2D_ARRAY,G.__webglTexture,n.TEXTURE0+E)}function B(b,E){const G=i.get(b);if(b.version>0&&G.__version!==b.version){Be(G,b,E);return}t.bindTexture(n.TEXTURE_3D,G.__webglTexture,n.TEXTURE0+E)}function Y(b,E){const G=i.get(b);if(b.version>0&&G.__version!==b.version){H(G,b,E);return}t.bindTexture(n.TEXTURE_CUBE_MAP,G.__webglTexture,n.TEXTURE0+E)}const L={[rm]:n.REPEAT,[co]:n.CLAMP_TO_EDGE,[sm]:n.MIRRORED_REPEAT},j={[zi]:n.NEAREST,[Vw]:n.NEAREST_MIPMAP_NEAREST,[lc]:n.NEAREST_MIPMAP_LINEAR,[tr]:n.LINEAR,[oh]:n.LINEAR_MIPMAP_NEAREST,[fo]:n.LINEAR_MIPMAP_LINEAR},P={[qw]:n.NEVER,[Jw]:n.ALWAYS,[$w]:n.LESS,[KS]:n.LEQUAL,[jw]:n.EQUAL,[Qw]:n.GEQUAL,[Kw]:n.GREATER,[Zw]:n.NOTEQUAL};function te(b,E){if(E.type===Nr&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===tr||E.magFilter===oh||E.magFilter===lc||E.magFilter===fo||E.minFilter===tr||E.minFilter===oh||E.minFilter===lc||E.minFilter===fo)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),n.texParameteri(b,n.TEXTURE_WRAP_S,L[E.wrapS]),n.texParameteri(b,n.TEXTURE_WRAP_T,L[E.wrapT]),(b===n.TEXTURE_3D||b===n.TEXTURE_2D_ARRAY)&&n.texParameteri(b,n.TEXTURE_WRAP_R,L[E.wrapR]),n.texParameteri(b,n.TEXTURE_MAG_FILTER,j[E.magFilter]),n.texParameteri(b,n.TEXTURE_MIN_FILTER,j[E.minFilter]),E.compareFunction&&(n.texParameteri(b,n.TEXTURE_COMPARE_MODE,n.COMPARE_REF_TO_TEXTURE),n.texParameteri(b,n.TEXTURE_COMPARE_FUNC,P[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===zi||E.minFilter!==lc&&E.minFilter!==fo||E.type===Nr&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||i.get(E).__currentAnisotropy){const G=e.get("EXT_texture_filter_anisotropic");n.texParameterf(b,G.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,r.getMaxAnisotropy())),i.get(E).__currentAnisotropy=E.anisotropy}}}function ye(b,E){let G=!1;b.__webglInit===void 0&&(b.__webglInit=!0,E.addEventListener("dispose",C));const J=E.source;let ie=f.get(J);ie===void 0&&(ie={},f.set(J,ie));const Z=z(E);if(Z!==b.__cacheKey){ie[Z]===void 0&&(ie[Z]={texture:n.createTexture(),usedTimes:0},o.memory.textures++,G=!0),ie[Z].usedTimes++;const Me=ie[b.__cacheKey];Me!==void 0&&(ie[b.__cacheKey].usedTimes--,Me.usedTimes===0&&R(E)),b.__cacheKey=Z,b.__webglTexture=ie[Z].texture}return G}function Be(b,E,G){let J=n.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(J=n.TEXTURE_2D_ARRAY),E.isData3DTexture&&(J=n.TEXTURE_3D);const ie=ye(b,E),Z=E.source;t.bindTexture(J,b.__webglTexture,n.TEXTURE0+G);const Me=i.get(Z);if(Z.version!==Me.__version||ie===!0){t.activeTexture(n.TEXTURE0+G);const oe=pt.getPrimaries(pt.workingColorSpace),fe=E.colorSpace===fs?null:pt.getPrimaries(E.colorSpace),Ve=E.colorSpace===fs||oe===fe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,E.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,E.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ve);let se=g(E.image,!1,r.maxTextureSize);se=We(E,se);const xe=s.convert(E.format,E.colorSpace),Se=s.convert(E.type);let Ue=v(E.internalFormat,xe,Se,E.colorSpace,E.isVideoTexture);te(J,E);let me;const Ye=E.mipmaps,Ne=E.isVideoTexture!==!0,tt=Me.__version===void 0||ie===!0,O=Z.dataReady,ne=S(E,se);if(E.isDepthTexture)Ue=x(E.format===Ka,E.type),tt&&(Ne?t.texStorage2D(n.TEXTURE_2D,1,Ue,se.width,se.height):t.texImage2D(n.TEXTURE_2D,0,Ue,se.width,se.height,0,xe,Se,null));else if(E.isDataTexture)if(Ye.length>0){Ne&&tt&&t.texStorage2D(n.TEXTURE_2D,ne,Ue,Ye[0].width,Ye[0].height);for(let K=0,ee=Ye.length;K<ee;K++)me=Ye[K],Ne?O&&t.texSubImage2D(n.TEXTURE_2D,K,0,0,me.width,me.height,xe,Se,me.data):t.texImage2D(n.TEXTURE_2D,K,Ue,me.width,me.height,0,xe,Se,me.data);E.generateMipmaps=!1}else Ne?(tt&&t.texStorage2D(n.TEXTURE_2D,ne,Ue,se.width,se.height),O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,se.width,se.height,xe,Se,se.data)):t.texImage2D(n.TEXTURE_2D,0,Ue,se.width,se.height,0,xe,Se,se.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){Ne&&tt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ne,Ue,Ye[0].width,Ye[0].height,se.depth);for(let K=0,ee=Ye.length;K<ee;K++)if(me=Ye[K],E.format!==ir)if(xe!==null)if(Ne){if(O)if(E.layerUpdates.size>0){const ce=Ov(me.width,me.height,E.format,E.type);for(const de of E.layerUpdates){const $e=me.data.subarray(de*ce/me.data.BYTES_PER_ELEMENT,(de+1)*ce/me.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,K,0,0,de,me.width,me.height,1,xe,$e,0,0)}E.clearLayerUpdates()}else t.compressedTexSubImage3D(n.TEXTURE_2D_ARRAY,K,0,0,0,me.width,me.height,se.depth,xe,me.data,0,0)}else t.compressedTexImage3D(n.TEXTURE_2D_ARRAY,K,Ue,me.width,me.height,se.depth,0,me.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Ne?O&&t.texSubImage3D(n.TEXTURE_2D_ARRAY,K,0,0,0,me.width,me.height,se.depth,xe,Se,me.data):t.texImage3D(n.TEXTURE_2D_ARRAY,K,Ue,me.width,me.height,se.depth,0,xe,Se,me.data)}else{Ne&&tt&&t.texStorage2D(n.TEXTURE_2D,ne,Ue,Ye[0].width,Ye[0].height);for(let K=0,ee=Ye.length;K<ee;K++)me=Ye[K],E.format!==ir?xe!==null?Ne?O&&t.compressedTexSubImage2D(n.TEXTURE_2D,K,0,0,me.width,me.height,xe,me.data):t.compressedTexImage2D(n.TEXTURE_2D,K,Ue,me.width,me.height,0,me.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Ne?O&&t.texSubImage2D(n.TEXTURE_2D,K,0,0,me.width,me.height,xe,Se,me.data):t.texImage2D(n.TEXTURE_2D,K,Ue,me.width,me.height,0,xe,Se,me.data)}else if(E.isDataArrayTexture)if(Ne){if(tt&&t.texStorage3D(n.TEXTURE_2D_ARRAY,ne,Ue,se.width,se.height,se.depth),O)if(E.layerUpdates.size>0){const K=Ov(se.width,se.height,E.format,E.type);for(const ee of E.layerUpdates){const ce=se.data.subarray(ee*K/se.data.BYTES_PER_ELEMENT,(ee+1)*K/se.data.BYTES_PER_ELEMENT);t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,ee,se.width,se.height,1,xe,Se,ce)}E.clearLayerUpdates()}else t.texSubImage3D(n.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,xe,Se,se.data)}else t.texImage3D(n.TEXTURE_2D_ARRAY,0,Ue,se.width,se.height,se.depth,0,xe,Se,se.data);else if(E.isData3DTexture)Ne?(tt&&t.texStorage3D(n.TEXTURE_3D,ne,Ue,se.width,se.height,se.depth),O&&t.texSubImage3D(n.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,xe,Se,se.data)):t.texImage3D(n.TEXTURE_3D,0,Ue,se.width,se.height,se.depth,0,xe,Se,se.data);else if(E.isFramebufferTexture){if(tt)if(Ne)t.texStorage2D(n.TEXTURE_2D,ne,Ue,se.width,se.height);else{let K=se.width,ee=se.height;for(let ce=0;ce<ne;ce++)t.texImage2D(n.TEXTURE_2D,ce,Ue,K,ee,0,xe,Se,null),K>>=1,ee>>=1}}else if(Ye.length>0){if(Ne&&tt){const K=Pe(Ye[0]);t.texStorage2D(n.TEXTURE_2D,ne,Ue,K.width,K.height)}for(let K=0,ee=Ye.length;K<ee;K++)me=Ye[K],Ne?O&&t.texSubImage2D(n.TEXTURE_2D,K,0,0,xe,Se,me):t.texImage2D(n.TEXTURE_2D,K,Ue,xe,Se,me);E.generateMipmaps=!1}else if(Ne){if(tt){const K=Pe(se);t.texStorage2D(n.TEXTURE_2D,ne,Ue,K.width,K.height)}O&&t.texSubImage2D(n.TEXTURE_2D,0,0,0,xe,Se,se)}else t.texImage2D(n.TEXTURE_2D,0,Ue,xe,Se,se);m(E)&&h(J),Me.__version=Z.version,E.onUpdate&&E.onUpdate(E)}b.__version=E.version}function H(b,E,G){if(E.image.length!==6)return;const J=ye(b,E),ie=E.source;t.bindTexture(n.TEXTURE_CUBE_MAP,b.__webglTexture,n.TEXTURE0+G);const Z=i.get(ie);if(ie.version!==Z.__version||J===!0){t.activeTexture(n.TEXTURE0+G);const Me=pt.getPrimaries(pt.workingColorSpace),oe=E.colorSpace===fs?null:pt.getPrimaries(E.colorSpace),fe=E.colorSpace===fs||Me===oe?n.NONE:n.BROWSER_DEFAULT_WEBGL;n.pixelStorei(n.UNPACK_FLIP_Y_WEBGL,E.flipY),n.pixelStorei(n.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),n.pixelStorei(n.UNPACK_ALIGNMENT,E.unpackAlignment),n.pixelStorei(n.UNPACK_COLORSPACE_CONVERSION_WEBGL,fe);const Ve=E.isCompressedTexture||E.image[0].isCompressedTexture,se=E.image[0]&&E.image[0].isDataTexture,xe=[];for(let ee=0;ee<6;ee++)!Ve&&!se?xe[ee]=g(E.image[ee],!0,r.maxCubemapSize):xe[ee]=se?E.image[ee].image:E.image[ee],xe[ee]=We(E,xe[ee]);const Se=xe[0],Ue=s.convert(E.format,E.colorSpace),me=s.convert(E.type),Ye=v(E.internalFormat,Ue,me,E.colorSpace),Ne=E.isVideoTexture!==!0,tt=Z.__version===void 0||J===!0,O=ie.dataReady;let ne=S(E,Se);te(n.TEXTURE_CUBE_MAP,E);let K;if(Ve){Ne&&tt&&t.texStorage2D(n.TEXTURE_CUBE_MAP,ne,Ye,Se.width,Se.height);for(let ee=0;ee<6;ee++){K=xe[ee].mipmaps;for(let ce=0;ce<K.length;ce++){const de=K[ce];E.format!==ir?Ue!==null?Ne?O&&t.compressedTexSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce,0,0,de.width,de.height,Ue,de.data):t.compressedTexImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce,Ye,de.width,de.height,0,de.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Ne?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce,0,0,de.width,de.height,Ue,me,de.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce,Ye,de.width,de.height,0,Ue,me,de.data)}}}else{if(K=E.mipmaps,Ne&&tt){K.length>0&&ne++;const ee=Pe(xe[0]);t.texStorage2D(n.TEXTURE_CUBE_MAP,ne,Ye,ee.width,ee.height)}for(let ee=0;ee<6;ee++)if(se){Ne?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,xe[ee].width,xe[ee].height,Ue,me,xe[ee].data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ye,xe[ee].width,xe[ee].height,0,Ue,me,xe[ee].data);for(let ce=0;ce<K.length;ce++){const $e=K[ce].image[ee].image;Ne?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce+1,0,0,$e.width,$e.height,Ue,me,$e.data):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce+1,Ye,$e.width,$e.height,0,Ue,me,$e.data)}}else{Ne?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,0,0,Ue,me,xe[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,0,Ye,Ue,me,xe[ee]);for(let ce=0;ce<K.length;ce++){const de=K[ce];Ne?O&&t.texSubImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce+1,0,0,Ue,me,de.image[ee]):t.texImage2D(n.TEXTURE_CUBE_MAP_POSITIVE_X+ee,ce+1,Ye,Ue,me,de.image[ee])}}}m(E)&&h(n.TEXTURE_CUBE_MAP),Z.__version=ie.version,E.onUpdate&&E.onUpdate(E)}b.__version=E.version}function Q(b,E,G,J,ie,Z){const Me=s.convert(G.format,G.colorSpace),oe=s.convert(G.type),fe=v(G.internalFormat,Me,oe,G.colorSpace);if(!i.get(E).__hasExternalTextures){const se=Math.max(1,E.width>>Z),xe=Math.max(1,E.height>>Z);ie===n.TEXTURE_3D||ie===n.TEXTURE_2D_ARRAY?t.texImage3D(ie,Z,fe,se,xe,E.depth,0,Me,oe,null):t.texImage2D(ie,Z,fe,se,xe,0,Me,oe,null)}t.bindFramebuffer(n.FRAMEBUFFER,b),He(E)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,J,ie,i.get(G).__webglTexture,0,Fe(E)):(ie===n.TEXTURE_2D||ie>=n.TEXTURE_CUBE_MAP_POSITIVE_X&&ie<=n.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&n.framebufferTexture2D(n.FRAMEBUFFER,J,ie,i.get(G).__webglTexture,Z),t.bindFramebuffer(n.FRAMEBUFFER,null)}function re(b,E,G){if(n.bindRenderbuffer(n.RENDERBUFFER,b),E.depthBuffer){const J=E.depthTexture,ie=J&&J.isDepthTexture?J.type:null,Z=x(E.stencilBuffer,ie),Me=E.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,oe=Fe(E);He(E)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,oe,Z,E.width,E.height):G?n.renderbufferStorageMultisample(n.RENDERBUFFER,oe,Z,E.width,E.height):n.renderbufferStorage(n.RENDERBUFFER,Z,E.width,E.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,Me,n.RENDERBUFFER,b)}else{const J=E.textures;for(let ie=0;ie<J.length;ie++){const Z=J[ie],Me=s.convert(Z.format,Z.colorSpace),oe=s.convert(Z.type),fe=v(Z.internalFormat,Me,oe,Z.colorSpace),Ve=Fe(E);G&&He(E)===!1?n.renderbufferStorageMultisample(n.RENDERBUFFER,Ve,fe,E.width,E.height):He(E)?a.renderbufferStorageMultisampleEXT(n.RENDERBUFFER,Ve,fe,E.width,E.height):n.renderbufferStorage(n.RENDERBUFFER,fe,E.width,E.height)}}n.bindRenderbuffer(n.RENDERBUFFER,null)}function le(b,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(n.FRAMEBUFFER,b),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(E.depthTexture).__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),X(E.depthTexture,0);const J=i.get(E.depthTexture).__webglTexture,ie=Fe(E);if(E.depthTexture.format===ba)He(E)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,J,0,ie):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_ATTACHMENT,n.TEXTURE_2D,J,0);else if(E.depthTexture.format===Ka)He(E)?a.framebufferTexture2DMultisampleEXT(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,J,0,ie):n.framebufferTexture2D(n.FRAMEBUFFER,n.DEPTH_STENCIL_ATTACHMENT,n.TEXTURE_2D,J,0);else throw new Error("Unknown depthTexture format")}function Ae(b){const E=i.get(b),G=b.isWebGLCubeRenderTarget===!0;if(E.__boundDepthTexture!==b.depthTexture){const J=b.depthTexture;if(E.__depthDisposeCallback&&E.__depthDisposeCallback(),J){const ie=()=>{delete E.__boundDepthTexture,delete E.__depthDisposeCallback,J.removeEventListener("dispose",ie)};J.addEventListener("dispose",ie),E.__depthDisposeCallback=ie}E.__boundDepthTexture=J}if(b.depthTexture&&!E.__autoAllocateDepthBuffer){if(G)throw new Error("target.depthTexture not supported in Cube render targets");le(E.__webglFramebuffer,b)}else if(G){E.__webglDepthbuffer=[];for(let J=0;J<6;J++)if(t.bindFramebuffer(n.FRAMEBUFFER,E.__webglFramebuffer[J]),E.__webglDepthbuffer[J]===void 0)E.__webglDepthbuffer[J]=n.createRenderbuffer(),re(E.__webglDepthbuffer[J],b,!1);else{const ie=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Z=E.__webglDepthbuffer[J];n.bindRenderbuffer(n.RENDERBUFFER,Z),n.framebufferRenderbuffer(n.FRAMEBUFFER,ie,n.RENDERBUFFER,Z)}}else if(t.bindFramebuffer(n.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer===void 0)E.__webglDepthbuffer=n.createRenderbuffer(),re(E.__webglDepthbuffer,b,!1);else{const J=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,ie=E.__webglDepthbuffer;n.bindRenderbuffer(n.RENDERBUFFER,ie),n.framebufferRenderbuffer(n.FRAMEBUFFER,J,n.RENDERBUFFER,ie)}t.bindFramebuffer(n.FRAMEBUFFER,null)}function Te(b,E,G){const J=i.get(b);E!==void 0&&Q(J.__webglFramebuffer,b,b.texture,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,0),G!==void 0&&Ae(b)}function qe(b){const E=b.texture,G=i.get(b),J=i.get(E);b.addEventListener("dispose",A);const ie=b.textures,Z=b.isWebGLCubeRenderTarget===!0,Me=ie.length>1;if(Me||(J.__webglTexture===void 0&&(J.__webglTexture=n.createTexture()),J.__version=E.version,o.memory.textures++),Z){G.__webglFramebuffer=[];for(let oe=0;oe<6;oe++)if(E.mipmaps&&E.mipmaps.length>0){G.__webglFramebuffer[oe]=[];for(let fe=0;fe<E.mipmaps.length;fe++)G.__webglFramebuffer[oe][fe]=n.createFramebuffer()}else G.__webglFramebuffer[oe]=n.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){G.__webglFramebuffer=[];for(let oe=0;oe<E.mipmaps.length;oe++)G.__webglFramebuffer[oe]=n.createFramebuffer()}else G.__webglFramebuffer=n.createFramebuffer();if(Me)for(let oe=0,fe=ie.length;oe<fe;oe++){const Ve=i.get(ie[oe]);Ve.__webglTexture===void 0&&(Ve.__webglTexture=n.createTexture(),o.memory.textures++)}if(b.samples>0&&He(b)===!1){G.__webglMultisampledFramebuffer=n.createFramebuffer(),G.__webglColorRenderbuffer=[],t.bindFramebuffer(n.FRAMEBUFFER,G.__webglMultisampledFramebuffer);for(let oe=0;oe<ie.length;oe++){const fe=ie[oe];G.__webglColorRenderbuffer[oe]=n.createRenderbuffer(),n.bindRenderbuffer(n.RENDERBUFFER,G.__webglColorRenderbuffer[oe]);const Ve=s.convert(fe.format,fe.colorSpace),se=s.convert(fe.type),xe=v(fe.internalFormat,Ve,se,fe.colorSpace,b.isXRRenderTarget===!0),Se=Fe(b);n.renderbufferStorageMultisample(n.RENDERBUFFER,Se,xe,b.width,b.height),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+oe,n.RENDERBUFFER,G.__webglColorRenderbuffer[oe])}n.bindRenderbuffer(n.RENDERBUFFER,null),b.depthBuffer&&(G.__webglDepthRenderbuffer=n.createRenderbuffer(),re(G.__webglDepthRenderbuffer,b,!0)),t.bindFramebuffer(n.FRAMEBUFFER,null)}}if(Z){t.bindTexture(n.TEXTURE_CUBE_MAP,J.__webglTexture),te(n.TEXTURE_CUBE_MAP,E);for(let oe=0;oe<6;oe++)if(E.mipmaps&&E.mipmaps.length>0)for(let fe=0;fe<E.mipmaps.length;fe++)Q(G.__webglFramebuffer[oe][fe],b,E,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,fe);else Q(G.__webglFramebuffer[oe],b,E,n.COLOR_ATTACHMENT0,n.TEXTURE_CUBE_MAP_POSITIVE_X+oe,0);m(E)&&h(n.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Me){for(let oe=0,fe=ie.length;oe<fe;oe++){const Ve=ie[oe],se=i.get(Ve);t.bindTexture(n.TEXTURE_2D,se.__webglTexture),te(n.TEXTURE_2D,Ve),Q(G.__webglFramebuffer,b,Ve,n.COLOR_ATTACHMENT0+oe,n.TEXTURE_2D,0),m(Ve)&&h(n.TEXTURE_2D)}t.unbindTexture()}else{let oe=n.TEXTURE_2D;if((b.isWebGL3DRenderTarget||b.isWebGLArrayRenderTarget)&&(oe=b.isWebGL3DRenderTarget?n.TEXTURE_3D:n.TEXTURE_2D_ARRAY),t.bindTexture(oe,J.__webglTexture),te(oe,E),E.mipmaps&&E.mipmaps.length>0)for(let fe=0;fe<E.mipmaps.length;fe++)Q(G.__webglFramebuffer[fe],b,E,n.COLOR_ATTACHMENT0,oe,fe);else Q(G.__webglFramebuffer,b,E,n.COLOR_ATTACHMENT0,oe,0);m(E)&&h(oe),t.unbindTexture()}b.depthBuffer&&Ae(b)}function Ge(b){const E=b.textures;for(let G=0,J=E.length;G<J;G++){const ie=E[G];if(m(ie)){const Z=b.isWebGLCubeRenderTarget?n.TEXTURE_CUBE_MAP:n.TEXTURE_2D,Me=i.get(ie).__webglTexture;t.bindTexture(Z,Me),h(Z),t.unbindTexture()}}}const Oe=[],D=[];function rt(b){if(b.samples>0){if(He(b)===!1){const E=b.textures,G=b.width,J=b.height;let ie=n.COLOR_BUFFER_BIT;const Z=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT,Me=i.get(b),oe=E.length>1;if(oe)for(let fe=0;fe<E.length;fe++)t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.RENDERBUFFER,null),t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.TEXTURE_2D,null,0);t.bindFramebuffer(n.READ_FRAMEBUFFER,Me.__webglMultisampledFramebuffer),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglFramebuffer);for(let fe=0;fe<E.length;fe++){if(b.resolveDepthBuffer&&(b.depthBuffer&&(ie|=n.DEPTH_BUFFER_BIT),b.stencilBuffer&&b.resolveStencilBuffer&&(ie|=n.STENCIL_BUFFER_BIT)),oe){n.framebufferRenderbuffer(n.READ_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.RENDERBUFFER,Me.__webglColorRenderbuffer[fe]);const Ve=i.get(E[fe]).__webglTexture;n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0,n.TEXTURE_2D,Ve,0)}n.blitFramebuffer(0,0,G,J,0,0,G,J,ie,n.NEAREST),l===!0&&(Oe.length=0,D.length=0,Oe.push(n.COLOR_ATTACHMENT0+fe),b.depthBuffer&&b.resolveDepthBuffer===!1&&(Oe.push(Z),D.push(Z),n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,D)),n.invalidateFramebuffer(n.READ_FRAMEBUFFER,Oe))}if(t.bindFramebuffer(n.READ_FRAMEBUFFER,null),t.bindFramebuffer(n.DRAW_FRAMEBUFFER,null),oe)for(let fe=0;fe<E.length;fe++){t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(n.FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.RENDERBUFFER,Me.__webglColorRenderbuffer[fe]);const Ve=i.get(E[fe]).__webglTexture;t.bindFramebuffer(n.FRAMEBUFFER,Me.__webglFramebuffer),n.framebufferTexture2D(n.DRAW_FRAMEBUFFER,n.COLOR_ATTACHMENT0+fe,n.TEXTURE_2D,Ve,0)}t.bindFramebuffer(n.DRAW_FRAMEBUFFER,Me.__webglMultisampledFramebuffer)}else if(b.depthBuffer&&b.resolveDepthBuffer===!1&&l){const E=b.stencilBuffer?n.DEPTH_STENCIL_ATTACHMENT:n.DEPTH_ATTACHMENT;n.invalidateFramebuffer(n.DRAW_FRAMEBUFFER,[E])}}}function Fe(b){return Math.min(r.maxSamples,b.samples)}function He(b){const E=i.get(b);return b.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function N(b){const E=o.render.frame;c.get(b)!==E&&(c.set(b,E),b.update())}function We(b,E){const G=b.colorSpace,J=b.format,ie=b.type;return b.isCompressedTexture===!0||b.isVideoTexture===!0||G!==Vs&&G!==fs&&(pt.getTransfer(G)===Pt?(J!==ir||ie!==Xr)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",G)),E}function Pe(b){return typeof HTMLImageElement<"u"&&b instanceof HTMLImageElement?(u.width=b.naturalWidth||b.width,u.height=b.naturalHeight||b.height):typeof VideoFrame<"u"&&b instanceof VideoFrame?(u.width=b.displayWidth,u.height=b.displayHeight):(u.width=b.width,u.height=b.height),u}this.allocateTextureUnit=U,this.resetTextureUnits=T,this.setTexture2D=X,this.setTexture2DArray=$,this.setTexture3D=B,this.setTextureCube=Y,this.rebindTextures=Te,this.setupRenderTarget=qe,this.updateRenderTargetMipmap=Ge,this.updateMultisampleRenderTarget=rt,this.setupDepthRenderbuffer=Ae,this.setupFrameBufferTexture=Q,this.useMultisampledRTT=He}function ob(n,e){function t(i,r=fs){let s;const o=pt.getTransfer(r);if(i===Xr)return n.UNSIGNED_BYTE;if(i===tg)return n.UNSIGNED_SHORT_4_4_4_4;if(i===ng)return n.UNSIGNED_SHORT_5_5_5_1;if(i===VS)return n.UNSIGNED_INT_5_9_9_9_REV;if(i===BS)return n.BYTE;if(i===HS)return n.SHORT;if(i===Mu)return n.UNSIGNED_SHORT;if(i===eg)return n.INT;if(i===Do)return n.UNSIGNED_INT;if(i===Nr)return n.FLOAT;if(i===ku)return n.HALF_FLOAT;if(i===GS)return n.ALPHA;if(i===WS)return n.RGB;if(i===ir)return n.RGBA;if(i===XS)return n.LUMINANCE;if(i===YS)return n.LUMINANCE_ALPHA;if(i===ba)return n.DEPTH_COMPONENT;if(i===Ka)return n.DEPTH_STENCIL;if(i===qS)return n.RED;if(i===ig)return n.RED_INTEGER;if(i===$S)return n.RG;if(i===rg)return n.RG_INTEGER;if(i===sg)return n.RGBA_INTEGER;if(i===rf||i===sf||i===of||i===af)if(o===Pt)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===rf)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===sf)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===of)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===af)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===rf)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===sf)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===of)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===af)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===om||i===am||i===lm||i===um)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===om)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===am)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===lm)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===um)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===cm||i===fm||i===dm)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===cm||i===fm)return o===Pt?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===dm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===hm||i===pm||i===mm||i===_m||i===gm||i===vm||i===xm||i===ym||i===Sm||i===Mm||i===Em||i===Tm||i===wm||i===Am)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===hm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===pm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===mm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===_m)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===gm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===vm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===xm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===ym)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Sm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Mm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Em)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Tm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===wm)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Am)return o===Pt?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===lf||i===Cm||i===Rm)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===lf)return o===Pt?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===Cm)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Rm)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===jS||i===Pm||i===bm||i===Dm)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===lf)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Pm)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===bm)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Dm)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===ja?n.UNSIGNED_INT_24_8:n[i]!==void 0?n[i]:null}return{convert:t}}class ab extends Ni{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Pc extends ti{constructor(){super(),this.isGroup=!0,this.type="Group"}}const lb={type:"move"};class Oh{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Pc,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Pc,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new q,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new q),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Pc,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new q,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new q),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,o=null;const a=this._targetRay,l=this._grip,u=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(u&&e.hand){o=!0;for(const g of e.hand.values()){const m=t.getJointPose(g,i),h=this._getHandJoint(u,g);m!==null&&(h.matrix.fromArray(m.transform.matrix),h.matrix.decompose(h.position,h.rotation,h.scale),h.matrixWorldNeedsUpdate=!0,h.jointRadius=m.radius),h.visible=m!==null}const c=u.joints["index-finger-tip"],d=u.joints["thumb-tip"],f=c.position.distanceTo(d.position),p=.02,_=.005;u.inputState.pinching&&f>p+_?(u.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!u.inputState.pinching&&f<=p-_&&(u.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(a.matrix.fromArray(r.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,r.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(r.linearVelocity)):a.hasLinearVelocity=!1,r.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(r.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(lb)))}return a!==null&&(a.visible=r!==null),l!==null&&(l.visible=s!==null),u!==null&&(u.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new Pc;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}const ub=`
void main() {
...
}`;class fb{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t,i){if(this.texture===null){const r=new ei,s=e.properties.get(r);s.__webglTexture=t.texture,(t.depthNear!=i.depthNear||t.depthFar!=i.depthFar)&&(this.depthNear=t.depthNear,this.depthFar=t.depthFar),this.texture=r}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,i=new qr({vertexShader:ub,fragmentShader:cb,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new Fr(new wd(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class db extends al{constructor(e,t){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,c=null,d=null,f=null,p=null,_=null;const g=new fb,m=t.getContextAttributes();let h=null,v=null;const x=[],S=[],C=new Tt;let A=null;const M=new Ni;M.layers.enable(1),M.viewport=new $t;const R=new Ni;R.layers.enable(2),R.viewport=new $t;const I=[M,R],y=new ab;y.layers.enable(1),y.layers.enable(2);let T=null,U=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(H){let Q=x[H];return Q===void 0&&(Q=new Oh,x[H]=Q),Q.getTargetRaySpace()},this.getControllerGrip=function(H){let Q=x[H];return Q===void 0&&(Q=new Oh,x[H]=Q),Q.getGripSpace()},this.getHand=function(H){let Q=x[H];return Q===void 0&&(Q=new Oh,x[H]=Q),Q.getHandSpace()};function z(H){const Q=S.indexOf(H.inputSource);if(Q===-1)return;const re=x[Q];re!==void 0&&(re.update(H.inputSource,H.frame,u||o),re.dispatchEvent({type:H.type,data:H.inputSource}))}function X(){r.removeEventListener("select",z),r.removeEventListener("selectstart",z),r.removeEventListener("selectend",z),r.removeEventListener("squeeze",z),r.removeEventListener("squeezestart",z),r.removeEventListener("squeezeend",z),r.removeEventListener("end",X),r.removeEventListener("inputsourceschange",$);for(let H=0;H<x.length;H++){const Q=S[H];Q!==null&&(S[H]=null,x[H].disconnect(Q))}T=null,U=null,g.reset(),e.setRenderTarget(h),p=null,f=null,d=null,r=null,v=null,Be.stop(),i.isPresenting=!1,e.setPixelRatio(A),e.setSize(C.width,C.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(H){s=H,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(H){a=H,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(H){u=H},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return d},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(H){if(r=H,r!==null){if(h=e.getRenderTarget(),r.addEventListener("select",z),r.addEventListener("selectstart",z),r.addEventListener("selectend",z),r.addEventListener("squeeze",z),r.addEventListener("squeezestart",z),r.addEventListener("squeezeend",z),r.addEventListener("end",X),r.addEventListener("inputsourceschange",$),m.xrCompatible!==!0&&await t.makeXRCompatible(),A=e.getPixelRatio(),e.getSize(C),r.renderState.layers===void 0){const Q={antialias:m.antialias,alpha:!0,depth:m.depth,stencil:m.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(r,t,Q),r.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),v=new Lo(p.framebufferWidth,p.framebufferHeight,{format:ir,type:Xr,colorSpace:e.outputColorSpace,stencilBuffer:m.stencil})}else{let Q=null,re=null,le=null;m.depth&&(le=m.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,Q=m.stencil?Ka:ba,re=m.stencil?ja:Do);const Ae={colorFormat:t.RGBA8,depthFormat:le,scaleFactor:s};d=new XRWebGLBinding(r,t),f=d.createProjectionLayer(Ae),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),v=new Lo(f.textureWidth,f.textureHeight,{format:ir,type:Xr,depthTexture:new fM(f.textureWidth,f.textureHeight,re,void 0,void 0,void 0,void 0,void 0,void 0,Q),stencilBuffer:m.stencil,colorSpace:e.outputColorSpace,samples:m.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1})}v.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),Be.setContext(r),Be.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function $(H){for(let Q=0;Q<H.removed.length;Q++){const re=H.removed[Q],le=S.indexOf(re);le>=0&&(S[le]=null,x[le].disconnect(re))}for(let Q=0;Q<H.added.length;Q++){const re=H.added[Q];let le=S.indexOf(re);if(le===-1){for(let Te=0;Te<x.length;Te++)if(Te>=S.length){S.push(re),le=Te;break}else if(S[Te]===null){S[Te]=re,le=Te;break}if(le===-1)break}const Ae=x[le];Ae&&Ae.connect(re)}}const B=new q,Y=new q;function L(H,Q,re){B.setFromMatrixPosition(Q.matrixWorld),Y.setFromMatrixPosition(re.matrixWorld);const le=B.distanceTo(Y),Ae=Q.projectionMatrix.elements,Te=re.projectionMatrix.elements,qe=Ae[14]/(Ae[10]-1),Ge=Ae[14]/(Ae[10]+1),Oe=(Ae[9]+1)/Ae[5],D=(Ae[9]-1)/Ae[5],rt=(Ae[8]-1)/Ae[0],Fe=(Te[8]+1)/Te[0],He=qe*rt,N=qe*Fe,We=le/(-rt+Fe),Pe=We*-rt;if(Q.matrixWorld.decompose(H.position,H.quaternion,H.scale),H.translateX(Pe),H.translateZ(We),H.matrixWorld.compose(H.position,H.quaternion,H.scale),H.matrixWorldInverse.copy(H.matrixWorld).invert(),Ae[10]===-1)H.projectionMatrix.copy(Q.projectionMatrix),H.projectionMatrixInverse.copy(Q.projectionMatrixInverse);else{const b=qe+We,E=Ge+We,G=He-Pe,J=N+(le-Pe),ie=Oe*Ge/E*b,Z=D*Ge/E*b;H.projectionMatrix.makePerspective(G,J,ie,Z,b,E),H.projectionMatrixInverse.copy(H.projectionMatrix).invert()}}function j(H,Q){Q===null?H.matrixWorld.copy(H.matrix):H.matrixWorld.multiplyMatrices(Q.matrixWorld,H.matrix),H.matrixWorldInverse.copy(H.matrixWorld).invert()}this.updateCamera=function(H){if(r===null)return;let Q=H.near,re=H.far;g.texture!==null&&(g.depthNear>0&&(Q=g.depthNear),g.depthFar>0&&(re=g.depthFar)),y.near=R.near=M.near=Q,y.far=R.far=M.far=re,(T!==y.near||U!==y.far)&&(r.updateRenderState({depthNear:y.near,depthFar:y.far}),T=y.near,U=y.far);const le=H.parent,Ae=y.cameras;j(y,le);for(let Te=0;Te<Ae.length;Te++)j(Ae[Te],le);Ae.length===2?L(y,M,R):y.projectionMatrix.copy(M.projectionMatrix),P(H,y,le)};function P(H,Q,re){re===null?H.matrix.copy(Q.matrixWorld):(H.matrix.copy(re.matrixWorld),H.matrix.invert(),H.matrix.multiply(Q.matrixWorld)),H.matrix.decompose(H.position,H.quaternion,H.scale),H.updateMatrixWorld(!0),H.projectionMatrix.copy(Q.projectionMatrix),H.projectionMatrixInverse.copy(Q.projectionMatrixInverse),H.isPerspectiveCamera&&(H.fov=Lm*2*Math.atan(1/H.projectionMatrix.elements[5]),H.zoom=1)}this.getCamera=function(){return y},this.getFoveation=function(){if(!(f===null&&p===null))return l},this.setFoveation=function(H){l=H,f!==null&&(f.fixedFoveation=H),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=H)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(y)};let te=null;function ye(H,Q){if(c=Q.getViewerPose(u||o),_=Q,c!==null){const re=c.views;p!==null&&(e.setRenderTargetFramebuffer(v,p.framebuffer),e.setRenderTarget(v));let le=!1;re.length!==y.cameras.length&&(y.cameras.length=0,le=!0);for(let Te=0;Te<re.length;Te++){const qe=re[Te];let Ge=null;if(p!==null)Ge=p.getViewport(qe);else{const D=d.getViewSubImage(f,qe);Ge=D.viewport,Te===0&&(e.setRenderTargetTextures(v,D.colorTexture,f.ignoreDepthValues?void 0:D.depthStencilTexture),e.setRenderTarget(v))}let Oe=I[Te];Oe===void 0&&(Oe=new Ni,Oe.layers.enable(Te),Oe.viewport=new $t,I[Te]=Oe),Oe.matrix.fromArray(qe.transform.matrix),Oe.matrix.decompose(Oe.position,Oe.quaternion,Oe.scale),Oe.projectionMatrix.fromArray(qe.projectionMatrix),Oe.projectionMatrixInverse.copy(Oe.projectionMatrix).invert(),Oe.viewport.set(Ge.x,Ge.y,Ge.width,Ge.height),Te===0&&(y.matrix.copy(Oe.matrix),y.matrix.decompose(y.position,y.quaternion,y.scale)),le===!0&&y.cameras.push(Oe)}const Ae=r.enabledFeatures;if(Ae&&Ae.includes("depth-sensing")){const Te=d.getDepthInformation(re[0]);Te&&Te.isValid&&Te.texture&&g.init(e,Te,r.renderState)}}for(let re=0;re<x.length;re++){const le=S[re],Ae=x[re];le!==null&&Ae!==void 0&&Ae.update(le,Q,u||o)}te&&te(H,Q),Q.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:Q}),_=null}const Be=new cM;Be.setAnimationLoop(ye),this.setAnimationLoop=function(H){te=H},this.dispose=function(){}}}const js=new Yr,hb=new Kt;function pb(n,e){function t(m,h){m.matrixAutoUpdate===!0&&m.updateMatrix(),h.value.copy(m.matrix)}function i(m,h){h.color.getRGB(m.fogColor.value,oM(n)),h.isFog?(m.fogNear.value=h.near,m.fogFar.value=h.far):h.isFogExp2&&(m.fogDensity.value=h.density)}function r(m,h,v,x,S){h.isMeshBasicMaterial||h.isMeshLambertMaterial?s(m,h):h.isMeshToonMaterial?(s(m,h),d(m,h)):h.isMeshPhongMaterial?(s(m,h),c(m,h)):h.isMeshStandardMaterial?(s(m,h),f(m,h),h.isMeshPhysicalMaterial&&p(m,h,S)):h.isMeshMatcapMaterial?(s(m,h),_(m,h)):h.isMeshDepthMaterial?s(m,h):h.isMeshDistanceMaterial?(s(m,h),g(m,h)):h.isMeshNormalMaterial?s(m,h):h.isLineBasicMaterial?(o(m,h),h.isLineDashedMaterial&&a(m,h)):h.isPointsMaterial?l(m,h,v,x):h.isSpriteMaterial?u(m,h):h.isShadowMaterial?(m.color.value.copy(h.color),m.opacity.value=h.opacity):h.isShaderMaterial&&(h.uniformsNeedUpdate=!1)}function s(m,h){m.opacity.value=h.opacity,h.color&&m.diffuse.value.copy(h.color),h.emissive&&m.emissive.value.copy(h.emissive).multiplyScalar(h.emissiveIntensity),h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.bumpMap&&(m.bumpMap.value=h.bumpMap,t(h.bumpMap,m.bumpMapTransform),m.bumpScale.value=h.bumpScale,h.side===Jn&&(m.bumpScale.value*=-1)),h.normalMap&&(m.normalMap.value=h.normalMap,t(h.normalMap,m.normalMapTransform),m.normalScale.value.copy(h.normalScale),h.side===Jn&&m.normalScale.value.negate()),h.displacementMap&&(m.displacementMap.value=h.displacementMap,t(h.displacementMap,m.displacementMapTransform),m.displacementScale.value=h.displacementScale,m.displacementBias.value=h.displacementBias),h.emissiveMap&&(m.emissiveMap.value=h.emissiveMap,t(h.emissiveMap,m.emissiveMapTransform)),h.specularMap&&(m.specularMap.value=h.specularMap,t(h.specularMap,m.specularMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest);const v=e.get(h),x=v.envMap,S=v.envMapRotation;x&&(m.envMap.value=x,js.copy(S),js.x*=-1,js.y*=-1,js.z*=-1,x.isCubeTexture&&x.isRenderTargetTexture===!1&&(js.y*=-1,js.z*=-1),m.envMapRotation.value.setFromMatrix4(hb.makeRotationFromEuler(js)),m.flipEnvMap.value=x.isCubeTexture&&x.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=h.reflectivity,m.ior.value=h.ior,m.refractionRatio.value=h.refractionRatio),h.lightMap&&(m.lightMap.value=h.lightMap,m.lightMapIntensity.value=h.lightMapIntensity,t(h.lightMap,m.lightMapTransform)),h.aoMap&&(m.aoMap.value=h.aoMap,m.aoMapIntensity.value=h.aoMapIntensity,t(h.aoMap,m.aoMapTransform))}function o(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform))}function a(m,h){m.dashSize.value=h.dashSize,m.totalSize.value=h.dashSize+h.gapSize,m.scale.value=h.scale}function l(m,h,v,x){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.size.value=h.size*v,m.scale.value=x*.5,h.map&&(m.map.value=h.map,t(h.map,m.uvTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function u(m,h){m.diffuse.value.copy(h.color),m.opacity.value=h.opacity,m.rotation.value=h.rotation,h.map&&(m.map.value=h.map,t(h.map,m.mapTransform)),h.alphaMap&&(m.alphaMap.value=h.alphaMap,t(h.alphaMap,m.alphaMapTransform)),h.alphaTest>0&&(m.alphaTest.value=h.alphaTest)}function c(m,h){m.specular.value.copy(h.specular),m.shininess.value=Math.max(h.shininess,1e-4)}function d(m,h){h.gradientMap&&(m.gradientMap.value=h.gradientMap)}function f(m,h){m.metalness.value=h.metalness,h.metalnessMap&&(m.metalnessMap.value=h.metalnessMap,t(h.metalnessMap,m.metalnessMapTransform)),m.roughness.value=h.roughness,h.roughnessMap&&(m.roughnessMap.value=h.roughnessMap,t(h.roughnessMap,m.roughnessMapTransform)),h.envMap&&(m.envMapIntensity.value=h.envMapIntensity)}function p(m,h,v){m.ior.value=h.ior,h.sheen>0&&(m.sheenColor.value.copy(h.sheenColor).multiplyScalar(h.sheen),m.sheenRoughness.value=h.sheenRoughness,h.sheenColorMap&&(m.sheenColorMap.value=h.sheenColorMap,t(h.sheenColorMap,m.sheenColorMapTransform)),h.sheenRoughnessMap&&(m.sheenRoughnessMap.value=h.sheenRoughnessMap,t(h.sheenRoughnessMap,m.sheenRoughnessMapTransform))),h.clearcoat>0&&(m.clearcoat.value=h.clearcoat,m.clearcoatRoughness.value=h.clearcoatRoughness,h.clearcoatMap&&(m.clearcoatMap.value=h.clearcoatMap,t(h.clearcoatMap,m.clearcoatMapTransform)),h.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=h.clearcoatRoughnessMap,t(h.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),h.clearcoatNormalMap&&(m.clearcoatNormalMap.value=h.clearcoatNormalMap,t(h.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(h.clearcoatNormalScale),h.side===Jn&&m.clearcoatNormalScale.value.negate())),h.dispersion>0&&(m.dispersion.value=h.dispersion),h.iridescence>0&&(m.iridescence.value=h.iridescence,m.iridescenceIOR.value=h.iridescenceIOR,m.iridescenceThicknessMinimum.value=h.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=h.iridescenceThicknessRange[1],h.iridescenceMap&&(m.iridescenceMap.value=h.iridescenceMap,t(h.iridescenceMap,m.iridescenceMapTransform)),h.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=h.iridescenceThicknessMap,t(h.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),h.transmission>0&&(m.transmission.value=h.transmission,m.transmissionSamplerMap.value=v.texture,m.transmissionSamplerSize.value.set(v.width,v.height),h.transmissionMap&&(m.transmissionMap.value=h.transmissionMap,t(h.transmissionMap,m.transmissionMapTransform)),m.thickness.value=h.thickness,h.thicknessMap&&(m.thicknessMap.value=h.thicknessMap,t(h.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=h.attenuationDistance,m.attenuationColor.value.copy(h.attenuationColor)),h.anisotropy>0&&(m.anisotropyVector.value.set(h.anisotropy*Math.cos(h.anisotropyRotation),h.anisotropy*Math.sin(h.anisotropyRotation)),h.anisotropyMap&&(m.anisotropyMap.value=h.anisotropyMap,t(h.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=h.specularIntensity,m.specularColor.value.copy(h.specularColor),h.specularColorMap&&(m.specularColorMap.value=h.specularColorMap,t(h.specularColorMap,m.specularColorMapTransform)),h.specularIntensityMap&&(m.specularIntensityMap.value=h.specularIntensityMap,t(h.specularIntensityMap,m.specularIntensityMapTransform))}function _(m,h){h.matcap&&(m.matcap.value=h.matcap)}function g(m,h){const v=e.get(h).light;m.referencePosition.value.setFromMatrixPosition(v.matrixWorld),m.nearDistance.value=v.shadow.camera.near,m.farDistance.value=v.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function mb(n,e,t,i){let r={},s={},o=[];const a=n.getParameter(n.MAX_UNIFORM_BUFFER_BINDINGS);function l(v,x){const S=x.program;i.uniformBlockBinding(v,S)}function u(v,x){let S=r[v.id];S===void 0&&(_(v),S=c(v),r[v.id]=S,v.addEventListener("dispose",m));const C=x.program;i.updateUBOMapping(v,C);const A=e.render.frame;s[v.id]!==A&&(f(v),s[v.id]=A)}function c(v){const x=d();v.__bindingPointIndex=x;const S=n.createBuffer(),C=v.__size,A=v.usage;return n.bindBuffer(n.UNIFORM_BUFFER,S),n.bufferData(n.UNIFORM_BUFFER,C,A),n.bindBuffer(n.UNIFORM_BUFFER,null),n.bindBufferBase(n.UNIFORM_BUFFER,x,S),S}function d(){for(let v=0;v<a;v++)if(o.indexOf(v)===-1)return o.push(v),v;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(v){const x=r[v.id],S=v.uniforms,C=v.__cache;n.bindBuffer(n.UNIFORM_BUFFER,x);for(let A=0,M=S.length;A<M;A++){const R=Array.isArray(S[A])?S[A]:[S[A]];for(let I=0,y=R.length;I<y;I++){const T=R[I];if(p(T,A,I,C)===!0){const U=T.__offset,z=Array.isArray(T.value)?T.value:[T.value];let X=0;for(let $=0;$<z.length;$++){const B=z[$],Y=g(B);typeof B=="number"||typeof B=="boolean"?(T.__data[0]=B,n.bufferSubData(n.UNIFORM_BUFFER,U+X,T.__data)):B.isMatrix3?(T.__data[0]=B.elements[0],T.__data[1]=B.elements[1],T.__data[2]=B.elements[2],T.__data[3]=0,T.__data[4]=B.elements[3],T.__data[5]=B.elements[4],T.__data[6]=B.elements[5],T.__data[7]=0,T.__data[8]=B.elements[6],T.__data[9]=B.elements[7],T.__data[10]=B.elements[8],T.__data[11]=0):(B.toArray(T.__data,X),X+=Y.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(n.UNIFORM_BUFFER,U,T.__data)}}}n.bindBuffer(n.UNIFORM_BUFFER,null)}function p(v,x,S,C){const A=v.value,M=x+"_"+S;if(C[M]===void 0)return typeof A=="number"||typeof A=="boolean"?C[M]=A:C[M]=A.clone(),!0;{const R=C[M];if(typeof A=="number"||typeof A=="boolean"){if(R!==A)return C[M]=A,!0}else if(R.equals(A)===!1)return R.copy(A),!0}return!1}function _(v){const x=v.uniforms;let S=0;const C=16;for(let M=0,R=x.length;M<R;M++){const I=Array.isArray(x[M])?x[M]:[x[M]];for(let y=0,T=I.length;y<T;y++){const U=I[y],z=Array.isArray(U.value)?U.value:[U.value];for(let X=0,$=z.length;X<$;X++){const B=z[X],Y=g(B),L=S%C,j=L%Y.boundary,P=L+j;S+=j,P!==0&&C-P<Y.storage&&(S+=C-P),U.__data=new Float32Array(Y.storage/Float32Array.BYTES_PER_ELEMENT),U.__offset=S,S+=Y.storage}}}const A=S%C;return A>0&&(S+=C-A),v.__size=S,v.__cache={},this}function g(v){const x={boundary:0,storage:0};return typeof v=="number"||typeof v=="boolean"?(x.boundary=4,x.storage=4):v.isVector2?(x.boundary=8,x.storage=8):v.isVector3||v.isColor?(x.boundary=16,x.storage=12):v.isVector4?(x.boundary=16,x.storage=16):v.isMatrix3?(x.boundary=48,x.storage=48):v.isMatrix4?(x.boundary=64,x.storage=64):v.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",v),x}function m(v){const x=v.target;x.removeEventListener("dispose",m);const S=o.indexOf(x.__bindingPointIndex);o.splice(S,1),n.deleteBuffer(r[x.id]),delete r[x.id],delete s[x.id]}function h(){for(const v in r)n.deleteBuffer(r[v]);o=[],r={},s={}}return{bind:l,update:u,dispose:h}}class _b{constructor(e={}){const{canvas:t=nA(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:c="default",failIfMajorPerformanceCaveat:d=!1}=e;this.isWebGLRenderer=!0;let f;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");f=i.getContextAttributes().alpha}else f=o;const p=new Uint32Array(4),_=new Int32Array(4);let g=null,m=null;const h=[],v=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this._outputColorSpace=ur,this.toneMapping=Rs,this.toneMappingExposure=1;const x=this;let S=!1,C=0,A=0,M=null,R=-1,I=null;const y=new $t,T=new $t;let U=null;const z=new gt(0);let X=0,$=t.width,B=t.height,Y=1,L=null,j=null;const P=new $t(0,0,$,B),te=new $t(0,0,$,B);let ye=!1;const Be=new uM;let H=!1,Q=!1;const re=new Kt,le=new Kt,Ae=new q,Te=new $t,qe={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let Ge=!1;function Oe(){return M===null?Y:1}let D=i;function rt(w,k){return t.getContext(w,k)}try{const w={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:c,failIfMajorPerformanceCaveat:d};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${J_}`),t.addEventListener("webglcontextlost",ee,!1),t.addEventListener("webglcontextrestored",ce,!1),t.addEventListener("webglcontextcreationerror",de,!1),D===null){const k="webgl2";if(D=rt(k,w),D===null)throw rt(k)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(w){throw console.error("THREE.WebGLRenderer: "+w.message),w}let Fe,He,N,We,Pe,b,E,G,J,ie,Z,Me,oe,fe,Ve,se,xe,Se,Ue,me,Ye,Ne,tt,O;function ne(){Fe=new SP(D),Fe.init(),Ne=new ob(D,Fe),He=new pP(D,Fe,e,Ne),N=new ib(D),He.reverseDepthBuffer&&N.buffers.depth.setReversed(!0),We=new TP(D),Pe=new V2,b=new sb(D,Fe,N,Pe,He,Ne,We),E=new _P(x),G=new yP(x),J=new bA(D),tt=new dP(D,J),ie=new MP(D,J,We,tt),Z=new AP(D,ie,J,We),Ue=new wP(D,He,b),se=new mP(Pe),Me=new H2(x,E,G,Fe,He,tt,se),oe=new pb(x,Pe),fe=new W2,Ve=new K2(Fe),Se=new fP(x,E,G,N,Z,f,l),xe=new tb(x,Z,He),O=new mb(D,We,He,N),me=new hP(D,Fe,We),Ye=new EP(D,Fe,We),We.programs=Me.programs,x.capabilities=He,x.extensions=Fe,x.properties=Pe,x.renderLists=fe,x.shadowMap=xe,x.state=N,x.info=We}ne();const K=new db(x,D);this.xr=K,this.getContext=function(){return D},this.getContextAttributes=function(){return D.getContextAttributes()},this.forceContextLoss=function(){const w=Fe.get("WEBGL_lose_context");w&&w.loseContext()},this.forceContextRestore=function(){const w=Fe.get("WEBGL_lose_context");w&&w.restoreContext()},this.getPixelRatio=function(){return Y},this.setPixelRatio=function(w){w!==void 0&&(Y=w,this.setSize($,B,!1))},this.getSize=function(w){return w.set($,B)},this.setSize=function(w,k,V=!0){if(K.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}$=w,B=k,t.width=Math.floor(w*Y),t.height=Math.floor(k*Y),V===!0&&(t.style.width=w+"px",t.style.height=k+"px"),this.setViewport(0,0,w,k)},this.getDrawingBufferSize=function(w){return w.set($*Y,B*Y).floor()},this.setDrawingBufferSize=function(w,k,V){$=w,B=k,Y=V,t.width=Math.floor(w*V),t.height=Math.floor(k*V),this.setViewport(0,0,w,k)},this.getCurrentViewport=function(w){return w.copy(y)},this.getViewport=function(w){return w.copy(P)},this.setViewport=function(w,k,V,W){w.isVector4?P.set(w.x,w.y,w.z,w.w):P.set(w,k,V,W),N.viewport(y.copy(P).multiplyScalar(Y).round())},this.getScissor=function(w){return w.copy(te)},this.setScissor=function(w,k,V,W){w.isVector4?te.set(w.x,w.y,w.z,w.w):te.set(w,k,V,W),N.scissor(T.copy(te).multiplyScalar(Y).round())},this.getScissorTest=function(){return ye},this.setScissorTest=function(w){N.setScissorTest(ye=w)},this.setOpaqueSort=function(w){L=w},this.setTransparentSort=function(w){j=w},this.getClearColor=function(w){return w.copy(Se.getClearColor())},this.setClearColor=function(){Se.setClearColor.apply(Se,arguments)},this.getClearAlpha=function(){return Se.getClearAlpha()},this.setClearAlpha=function(){Se.setClearAlpha.apply(Se,arguments)},this.clear=function(w=!0,k=!0,V=!0){let W=0;if(w){let F=!1;if(M!==null){const ue=M.texture.format;F=ue===sg||ue===rg||ue===ig}if(F){const ue=M.texture.type,ve=ue===Xr||ue===Do||ue===Mu||ue===ja||ue===tg||ue===ng,pe=Se.getClearColor(),he=Se.getClearAlpha(),be=pe.r,ze=pe.g,Re=pe.b;ve?(p[0]=be,p[1]=ze,p[2]=Re,p[3]=he,D.clearBufferuiv(D.COLOR,0,p)):(_[0]=be,_[1]=ze,_[2]=Re,_[3]=he,D.clearBufferiv(D.COLOR,0,_))}else W|=D.COLOR_BUFFER_BIT}k&&(W|=D.DEPTH_BUFFER_BIT,D.clearDepth(this.capabilities.reverseDepthBuffer?0:1)),V&&(W|=D.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),D.clear(W)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ee,!1),t.removeEventListener("webglcontextrestored",ce,!1),t.removeEventListener("webglcontextcreationerror",de,!1),fe.dispose(),Ve.dispose(),Pe.dispose(),E.dispose(),G.dispose(),Z.dispose(),tt.dispose(),O.dispose(),Me.dispose(),K.dispose(),K.removeEventListener("sessionstart",ct),K.removeEventListener("sessionend",_e),ke.stop()};function ee(w){w.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),S=!0}function ce(){console.log("THREE.WebGLRenderer: Context Restored."),S=!1;const w=We.autoReset,k=xe.enabled,V=xe.autoUpdate,W=xe.needsUpdate,F=xe.type;ne(),We.autoReset=w,xe.enabled=k,xe.autoUpdate=V,xe.needsUpdate=W,xe.type=F}function de(w){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",w.statusMessage)}function $e(w){const k=w.target;k.removeEventListener("dispose",$e),yt(k)}function yt(w){Dt(w),Pe.remove(w)}function Dt(w){const k=Pe.get(w).programs;k!==void 0&&(k.forEach(function(V){Me.releaseProgram(V)}),w.isShaderMaterial&&Me.releaseShaderCache(w))}this.renderBufferDirect=function(w,k,V,W,F,ue){k===null&&(k=qe);const ve=F.isMesh&&F.matrixWorld.determinant()<0,pe=mt(w,k,V,W,F);N.setMaterial(W,ve);let he=V.index,be=1;if(W.wireframe===!0){if(he=ie.getWireframeAttribute(V),he===void 0)return;be=2}const ze=V.drawRange,Re=V.attributes.position;let lt=ze.start*be,at=(ze.start+ze.count)*be;ue!==null&&(lt=Math.max(lt,ue.start*be),at=Math.min(at,(ue.start+ue.count)*be)),he!==null?(lt=Math.max(lt,0),at=Math.min(at,he.count)):Re!=null&&(lt=Math.max(lt,0),at=Math.min(at,Re.count));const xt=at-lt;if(xt<0||xt===1/0)return;tt.setup(F,W,pe,V,he);let ln,Je=me;if(he!==null&&(ln=J.get(he),Je=Ye,Je.setIndex(ln)),F.isMesh)W.wireframe===!0?(N.setLineWidth(W.wireframeLinewidth*Oe()),Je.setMode(D.LINES)):Je.setMode(D.TRIANGLES);else if(F.isLine){let Ie=W.linewidth;Ie===void 0&&(Ie=1),N.setLineWidth(Ie*Oe()),F.isLineSegments?Je.setMode(D.LINES):F.isLineLoop?Je.setMode(D.LINE_LOOP):Je.setMode(D.LINE_STRIP)}else F.isPoints?Je.setMode(D.POINTS):F.isSprite&&Je.setMode(D.TRIANGLES);if(F.isBatchedMesh)if(F._multiDrawInstances!==null)Je.renderMultiDrawInstances(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount,F._multiDrawInstances);else if(Fe.get("WEBGL_multi_draw"))Je.renderMultiDraw(F._multiDrawStarts,F._multiDrawCounts,F._multiDrawCount);else{const Ie=F._multiDrawStarts,mn=F._multiDrawCounts,dt=F._multiDrawCount,Yi=he?J.get(he).bytesPerElement:1,zo=Pe.get(W).currentProgram.getUniforms();for(let li=0;li<dt;li++)zo.setValue(D,"_gl_DrawID",li),Je.render(Ie[li]/Yi,mn[li])}else if(F.isInstancedMesh)Je.renderInstances(lt,xt,F.count);else if(V.isInstancedBufferGeometry){const Ie=V._maxInstanceCount!==void 0?V._maxInstanceCount:1/0,mn=Math.min(V.instanceCount,Ie);Je.renderInstances(lt,xt,mn)}else Je.render(lt,xt)};function st(w,k,V){w.transparent===!0&&w.side===Dr&&w.forceSinglePass===!1?(w.side=Jn,w.needsUpdate=!0,Wt(w,k,V),w.side=Us,w.needsUpdate=!0,Wt(w,k,V),w.side=Dr):Wt(w,k,V)}this.compile=function(w,k,V=null){V===null&&(V=w),m=Ve.get(V),m.init(k),v.push(m),V.traverseVisible(function(F){F.isLight&&F.layers.test(k.layers)&&(m.pushLight(F),F.castShadow&&m.pushShadow(F))}),w!==V&&w.traverseVisible(function(F){F.isLight&&F.layers.test(k.layers)&&(m.pushLight(F),F.castShadow&&m.pushShadow(F))}),m.setupLights();const W=new Set;return w.traverse(function(F){if(!(F.isMesh||F.isPoints||F.isLine||F.isSprite))return;const ue=F.material;if(ue)if(Array.isArray(ue))for(let ve=0;ve<ue.length;ve++){const pe=ue[ve];st(pe,V,F),W.add(pe)}else st(ue,V,F),W.add(ue)}),v.pop(),m=null,W},this.compileAsync=function(w,k,V=null){const W=this.compile(w,k,V);return new Promise(F=>{function ue(){if(W.forEach(function(ve){Pe.get(ve).currentProgram.isReady()&&W.delete(ve)}),W.size===0){F(w);return}setTimeout(ue,10)}Fe.get("KHR_parallel_shader_compile")!==null?ue():setTimeout(ue,10)})};let De=null;function Ce(w){De&&De(w)}function ct(){ke.stop()}function _e(){ke.start()}const ke=new cM;ke.setAnimationLoop(Ce),typeof self<"u"&&ke.setContext(self),this.setAnimationLoop=function(w){De=w,K.setAnimationLoop(w),w===null?ke.stop():ke.start()},K.addEventListener("sessionstart",ct),K.addEventListener("sessionend",_e),this.render=function(w,k){if(k!==void 0&&k.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(S===!0)return;if(w.matrixWorldAutoUpdate===!0&&w.updateMatrixWorld(),k.parent===null&&k.matrixWorldAutoUpdate===!0&&k.updateMatrixWorld(),K.enabled===!0&&K.isPresenting===!0&&(K.cameraAutoUpdate===!0&&K.updateCamera(k),k=K.getCamera()),w.isScene===!0&&w.onBeforeRender(x,w,k,M),m=Ve.get(w,v.length),m.init(k),v.push(m),le.multiplyMatrices(k.projectionMatrix,k.matrixWorldInverse),Be.setFromProjectionMatrix(le),Q=this.localClippingEnabled,H=se.init(this.clippingPlanes,Q),g=fe.get(w,h.length),g.init(),h.push(g),K.enabled===!0&&K.isPresenting===!0){const ue=x.xr.getDepthSensingMesh();ue!==null&&Le(ue,k,-1/0,x.sortObjects)}Le(w,k,0,x.sortObjects),g.finish(),x.sortObjects===!0&&g.sort(L,j),Ge=K.enabled===!1||K.isPresenting===!1||K.hasDepthSensing()===!1,Ge&&Se.addToRenderList(g,w),this.info.render.frame++,H===!0&&se.beginShadows();const V=m.state.shadowsArray;xe.render(V,w,k),H===!0&&se.endShadows(),this.info.autoReset===!0&&this.info.reset();const W=g.opaque,F=g.transmissive;if(m.setupLights(),k.isArrayCamera){const ue=k.cameras;if(F.length>0)for(let ve=0,pe=ue.length;ve<pe;ve++){const he=ue[ve];Gt(W,F,w,he)}Ge&&Se.render(w);for(let ve=0,pe=ue.length;ve<pe;ve++){const he=ue[ve];Xe(g,w,he,he.viewport)}}else F.length>0&&Gt(W,F,w,k),Ge&&Se.render(w),Xe(g,w,k);M!==null&&(b.updateMultisampleRenderTarget(M),b.updateRenderTargetMipmap(M)),w.isScene===!0&&w.onAfterRender(x,w,k),tt.resetDefaultState(),R=-1,I=null,v.pop(),v.length>0?(m=v[v.length-1],H===!0&&se.setGlobalState(x.clippingPlanes,m.state.camera)):m=null,h.pop(),h.length>0?g=h[h.length-1]:g=null};function Le(w,k,V,W){if(w.visible===!1)return;if(w.layers.test(k.layers)){if(w.isGroup)V=w.renderOrder;else if(w.isLOD)w.autoUpdate===!0&&w.update(k);else if(w.isLight)m.pushLight(w),w.castShadow&&m.pushShadow(w);else if(w.isSprite){if(!w.frustumCulled||Be.intersectsSprite(w)){W&&Te.setFromMatrixPosition(w.matrixWorld).applyMatrix4(le);const ve=Z.update(w),pe=w.material;pe.visible&&g.push(w,ve,pe,V,Te.z,null)}}else if((w.isMesh||w.isLine||w.isPoints)&&(!w.frustumCulled||Be.intersectsObject(w))){const ve=Z.update(w),pe=w.material;if(W&&(w.boundingSphere!==void 0?(w.boundingSphere===null&&w.computeBoundingSphere(),Te.copy(w.boundingSphere.center)):(ve.boundingSphere===null&&ve.computeBoundingSphere(),Te.copy(ve.boundingSphere.center)),Te.applyMatrix4(w.matrixWorld).applyMatrix4(le)),Array.isArray(pe)){const he=ve.groups;for(let be=0,ze=he.length;be<ze;be++){const Re=he[be],lt=pe[Re.materialIndex];lt&&lt.visible&&g.push(w,ve,lt,V,Te.z,Re)}}else pe.visible&&g.push(w,ve,pe,V,Te.z,null)}}const ue=w.children;for(let ve=0,pe=ue.length;ve<pe;ve++)Le(ue[ve],k,V,W)}function Xe(w,k,V,W){const F=w.opaque,ue=w.transmissive,ve=w.transparent;m.setupLightsView(V),H===!0&&se.setGlobalState(x.clippingPlanes,V),W&&N.viewport(y.copy(W)),F.length>0&&Ke(F,k,V),ue.length>0&&Ke(ue,k,V),ve.length>0&&Ke(ve,k,V),N.buffers.depth.setTest(!0),N.buffers.depth.setMask(!0),N.buffers.color.setMask(!0),N.setPolygonOffset(!1)}function Gt(w,k,V,W){if((V.isScene===!0?V.overrideMaterial:null)!==null)return;m.state.transmissionRenderTarget[W.id]===void 0&&(m.state.transmissionRenderTarget[W.id]=new Lo(1,1,{generateMipmaps:!0,type:Fe.has("EXT_color_buffer_half_float")||Fe.has("EXT_color_buffer_float")?ku:Xr,minFilter:fo,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:pt.workingColorSpace}));const ue=m.state.transmissionRenderTarget[W.id],ve=W.viewport||y;ue.setSize(ve.z,ve.w);const pe=x.getRenderTarget();x.setRenderTarget(ue),x.getClearColor(z),X=x.getClearAlpha(),X<1&&x.setClearColor(16777215,.5),x.clear(),Ge&&Se.render(V);const he=x.toneMapping;x.toneMapping=Rs;const be=W.viewport;if(W.viewport!==void 0&&(W.viewport=void 0),m.setupLightsView(W),H===!0&&se.setGlobalState(x.clippingPlanes,W),Ke(w,V,W),b.updateMultisampleRenderTarget(ue),b.updateRenderTargetMipmap(ue),Fe.has("WEBGL_multisampled_render_to_texture")===!1){let ze=!1;for(let Re=0,lt=k.length;Re<lt;Re++){const at=k[Re],xt=at.object,ln=at.geometry,Je=at.material,Ie=at.group;if(Je.side===Dr&&xt.layers.test(W.layers)){const mn=Je.side;Je.side=Jn,Je.needsUpdate=!0,Lt(xt,V,W,ln,Je,Ie),Je.side=mn,Je.needsUpdate=!0,ze=!0}}ze===!0&&(b.updateMultisampleRenderTarget(ue),b.updateRenderTargetMipmap(ue))}x.setRenderTarget(pe),x.setClearColor(z,X),be!==void 0&&(W.viewport=be),x.toneMapping=he}function Ke(w,k,V){const W=k.isScene===!0?k.overrideMaterial:null;for(let F=0,ue=w.length;F<ue;F++){const ve=w[F],pe=ve.object,he=ve.geometry,be=W===null?ve.material:W,ze=ve.group;pe.layers.test(V.layers)&&Lt(pe,k,V,he,be,ze)}}function Lt(w,k,V,W,F,ue){w.onBeforeRender(x,k,V,W,F,ue),w.modelViewMatrix.multiplyMatrices(V.matrixWorldInverse,w.matrixWorld),w.normalMatrix.getNormalMatrix(w.modelViewMatrix),F.onBeforeRender(x,k,V,W,w,ue),F.transparent===!0&&F.side===Dr&&F.forceSinglePass===!1?(F.side=Jn,F.needsUpdate=!0,x.renderBufferDirect(V,k,W,F,w,ue),F.side=Us,F.needsUpdate=!0,x.renderBufferDirect(V,k,W,F,w,ue),F.side=Dr):x.renderBufferDirect(V,k,W,F,w,ue),w.onAfterRender(x,k,V,W,F,ue)}function Wt(w,k,V){k.isScene!==!0&&(k=qe);const W=Pe.get(w),F=m.state.lights,ue=m.state.shadowsArray,ve=F.state.version,pe=Me.getParameters(w,F.state,ue,k,V),he=Me.getProgramCacheKey(pe);let be=W.programs;W.environment=w.isMeshStandardMaterial?k.environment:null,W.fog=k.fog,W.envMap=(w.isMeshStandardMaterial?G:E).get(w.envMap||W.environment),W.envMapRotation=W.environment!==null&&w.envMap===null?k.environmentRotation:w.envMapRotation,be===void 0&&(w.addEventListener("dispose",$e),be=new Map,W.programs=be);let ze=be.get(he);if(ze!==void 0){if(W.currentProgram===ze&&W.lightsStateVersion===ve)return St(w,pe),ze}else pe.uniforms=Me.getUniforms(w),w.onBeforeCompile(pe,x),ze=Me.acquireProgram(pe,he),be.set(he,ze),W.uniforms=pe.uniforms;const Re=W.uniforms;return(!w.isShaderMaterial&&!w.isRawShaderMaterial||w.clipping===!0)&&(Re.clippingPlanes=se.uniform),St(w,pe),W.needsLights=Ct(w),W.lightsStateVersion=ve,W.needsLights&&(Re.ambientLightColor.value=F.state.ambient,Re.lightProbe.value=F.state.probe,Re.directionalLights.value=F.state.directional,Re.directionalLightShadows.value=F.state.directionalShadow,Re.spotLights.value=F.state.spot,Re.spotLightShadows.value=F.state.spotShadow,Re.rectAreaLights.value=F.state.rectArea,Re.ltc_1.value=F.state.rectAreaLTC1,Re.ltc_2.value=F.state.rectAreaLTC2,Re.pointLights.value=F.state.point,Re.pointLightShadows.value=F.state.pointShadow,Re.hemisphereLights.value=F.state.hemi,Re.directionalShadowMap.value=F.state.directionalShadowMap,Re.directionalShadowMatrix.value=F.state.directionalShadowMatrix,Re.spotShadowMap.value=F.state.spotShadowMap,Re.spotLightMatrix.value=F.state.spotLightMatrix,Re.spotLightMap.value=F.state.spotLightMap,Re.pointShadowMap.value=F.state.pointShadowMap,Re.pointShadowMatrix.value=F.state.pointShadowMatrix),W.currentProgram=ze,W.uniformsList=null,ze}function At(w){if(w.uniformsList===null){const k=w.currentProgram.getUniforms();w.uniformsList=cf.seqWithValue(k.seq,w.uniforms)}return w.uniformsList}function St(w,k){const V=Pe.get(w);V.outputColorSpace=k.outputColorSpace,V.batching=k.batching,V.batchingColor=k.batchingColor,V.instancing=k.instancing,V.instancingColor=k.instancingColor,V.instancingMorph=k.instancingMorph,V.skinning=k.skinning,V.morphTargets=k.morphTargets,V.morphNormals=k.morphNormals,V.morphColors=k.morphColors,V.morphTargetsCount=k.morphTargetsCount,V.numClippingPlanes=k.numClippingPlanes,V.numIntersection=k.numClipIntersection,V.vertexAlphas=k.vertexAlphas,V.vertexTangents=k.vertexTangents,V.toneMapping=k.toneMapping}function mt(w,k,V,W,F){k.isScene!==!0&&(k=qe),b.resetTextureUnits();const ue=k.fog,ve=W.isMeshStandardMaterial?k.environment:null,pe=M===null?x.outputColorSpace:M.isXRRenderTarget===!0?M.texture.colorSpace:Vs,he=(W.isMeshStandardMaterial?G:E).get(W.envMap||ve),be=W.vertexColors===!0&&!!V.attributes.color&&V.attributes.color.itemSize===4,ze=!!V.attributes.tangent&&(!!W.normalMap||W.anisotropy>0),Re=!!V.morphAttributes.position,lt=!!V.morphAttributes.normal,at=!!V.morphAttributes.color;let xt=Rs;W.toneMapped&&(M===null||M.isXRRenderTarget===!0)&&(xt=x.toneMapping);const ln=V.morphAttributes.position||V.morphAttributes.normal||V.morphAttributes.color,Je=ln!==void 0?ln.length:0,Ie=Pe.get(W),mn=m.state.lights;if(H===!0&&(Q===!0||w!==I)){const Pi=w===I&&W.id===R;se.setState(W,w,Pi)}let dt=!1;W.version===Ie.__version?(Ie.needsLights&&Ie.lightsStateVersion!==mn.state.version||Ie.outputColorSpace!==pe||F.isBatchedMesh&&Ie.batching===!1||!F.isBatchedMesh&&Ie.batching===!0||F.isBatchedMesh&&Ie.batchingColor===!0&&F.colorTexture===null||F.isBatchedMesh&&Ie.batchingColor===!1&&F.colorTexture!==null||F.isInstancedMesh&&Ie.instancing===!1||!F.isInstancedMesh&&Ie.instancing===!0||F.isSkinnedMesh&&Ie.skinning===!1||!F.isSkinnedMesh&&Ie.skinning===!0||F.isInstancedMesh&&Ie.instancingColor===!0&&F.instanceColor===null||F.isInstancedMesh&&Ie.instancingColor===!1&&F.instanceColor!==null||F.isInstancedMesh&&Ie.instancingMorph===!0&&F.morphTexture===null||F.isInstancedMesh&&Ie.instancingMorph===!1&&F.morphTexture!==null||Ie.envMap!==he||W.fog===!0&&Ie.fog!==ue||Ie.numClippingPlanes!==void 0&&(Ie.numClippingPlanes!==se.numPlanes||Ie.numIntersection!==se.numIntersection)||Ie.vertexAlphas!==be||Ie.vertexTangents!==ze||Ie.morphTargets!==Re||Ie.morphNormals!==lt||Ie.morphColors!==at||Ie.toneMapping!==xt||Ie.morphTargetsCount!==Je)&&(dt=!0):(dt=!0,Ie.__version=W.version);let Yi=Ie.currentProgram;dt===!0&&(Yi=Wt(W,k,F));let zo=!1,li=!1,Dd=!1;const Xt=Yi.getUniforms(),Qr=Ie.uniforms;if(N.useProgram(Yi.program)&&(zo=!0,li=!0,Dd=!0),W.id!==R&&(R=W.id,li=!0),zo||I!==w){He.reverseDepthBuffer?(re.copy(w.projectionMatrix),rA(re),sA(re),Xt.setValue(D,"projectionMatrix",re)):Xt.setValue(D,"projectionMatrix",w.projectionMatrix),Xt.setValue(D,"viewMatrix",w.matrixWorldInverse);const Pi=Xt.map.cameraPosition;Pi!==void 0&&Pi.setValue(D,Ae.setFromMatrixPosition(w.matrixWorld)),He.logarithmicDepthBuffer&&Xt.setValue(D,"logDepthBufFC",2/(Math.log(w.far+1)/Math.LN2)),(W.isMeshPhongMaterial||W.isMeshToonMaterial||W.isMeshLambertMaterial||W.isMeshBasicMaterial||W.isMeshStandardMaterial||W.isShaderMaterial)&&Xt.setValue(D,"isOrthographic",w.isOrthographicCamera===!0),I!==w&&(I=w,li=!0,Dd=!0)}if(F.isSkinnedMesh){Xt.setOptional(D,F,"bindMatrix"),Xt.setOptional(D,F,"bindMatrixInverse");const Pi=F.skeleton;Pi&&(Pi.boneTexture===null&&Pi.computeBoneTexture(),Xt.setValue(D,"boneTexture",Pi.boneTexture,b))}F.isBatchedMesh&&(Xt.setOptional(D,F,"batchingTexture"),Xt.setValue(D,"batchingTexture",F._matricesTexture,b),Xt.setOptional(D,F,"batchingIdTexture"),Xt.setValue(D,"batchingIdTexture",F._indirectTexture,b),Xt.setOptional(D,F,"batchingColorTexture"),F._colorsTexture!==null&&Xt.setValue(D,"batchingColorTexture",F._colorsTexture,b));const Ld=V.morphAttributes;if((Ld.position!==void 0||Ld.normal!==void 0||Ld.color!==void 0)&&Ue.update(F,V,Yi),(li||Ie.receiveShadow!==F.receiveShadow)&&(Ie.receiveShadow=F.receiveShadow,Xt.setValue(D,"receiveShadow",F.receiveShadow)),W.isMeshGouraudMaterial&&W.envMap!==null&&(Qr.envMap.value=he,Qr.flipEnvMap.value=he.isCubeTexture&&he.isRenderTargetTexture===!1?-1:1),W.isMeshStandardMaterial&&W.envMap===null&&k.environment!==null&&(Qr.envMapIntensity.value=k.environmentIntensity),li&&(Xt.setValue(D,"toneMappingExposure",x.toneMappingExposure),Ie.needsLights&&ai(Qr,Dd),ue&&W.fog===!0&&oe.refreshFogUniforms(Qr,ue),oe.refreshMaterialUniforms(Qr,W,Y,B,m.state.transmissionRenderTarget[w.id]),cf.upload(D,At(Ie),Qr,b)),W.isShaderMaterial&&W.uniformsNeedUpdate===!0&&(cf.upload(D,At(Ie),Qr,b),W.uniformsNeedUpdate=!1),W.isSpriteMaterial&&Xt.setValue(D,"center",F.center),Xt.setValue(D,"modelViewMatrix",F.modelViewMatrix),Xt.setValue(D,"normalMatrix",F.normalMatrix),Xt.setValue(D,"modelMatrix",F.matrixWorld),W.isShaderMaterial||W.isRawShaderMaterial){const Pi=W.uniformsGroups;for(let Id=0,FE=Pi.length;Id<FE;Id++){const Ug=Pi[Id];O.update(Ug,Yi),O.bind(Ug,Yi)}}return Yi}function ai(w,k){w.ambientLightColor.needsUpdate=k,w.lightProbe.needsUpdate=k,w.directionalLights.needsUpdate=k,w.directionalLightShadows.needsUpdate=k,w.pointLights.needsUpdate=k,w.pointLightShadows.needsUpdate=k,w.spotLights.needsUpdate=k,w.spotLightShadows.needsUpdate=k,w.rectAreaLights.needsUpdate=k,w.hemisphereLights.needsUpdate=k}function Ct(w){return w.isMeshLambertMaterial||w.isMeshToonMaterial||w.isMeshPhongMaterial||w.isMeshStandardMaterial||w.isShadowMaterial||w.isShaderMaterial&&w.lights===!0}this.getActiveCubeFace=function(){return C},this.getActiveMipmapLevel=function(){return A},this.getRenderTarget=function(){return M},this.setRenderTargetTextures=function(w,k,V){Pe.get(w.texture).__webglTexture=k,Pe.get(w.depthTexture).__webglTexture=V;const W=Pe.get(w);W.__hasExternalTextures=!0,W.__autoAllocateDepthBuffer=V===void 0,W.__autoAllocateDepthBuffer||Fe.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),W.__useRenderToTexture=!1)},this.setRenderTargetFramebuffer=function(w,k){const V=Pe.get(w);V.__webglFramebuffer=k,V.__useDefaultFramebuffer=k===void 0},this.setRenderTarget=function(w,k=0,V=0){M=w,C=k,A=V;let W=!0,F=null,ue=!1,ve=!1;if(w){const he=Pe.get(w);if(he.__useDefaultFramebuffer!==void 0)N.bindFramebuffer(D.FRAMEBUFFER,null),W=!1;else if(he.__webglFramebuffer===void 0)b.setupRenderTarget(w);else if(he.__hasExternalTextures)b.rebindTextures(w,Pe.get(w.texture).__webglTexture,Pe.get(w.depthTexture).__webglTexture);else if(w.depthBuffer){const Re=w.depthTexture;if(he.__boundDepthTexture!==Re){if(Re!==null&&Pe.has(Re)&&(w.width!==Re.image.width||w.height!==Re.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");b.setupDepthRenderbuffer(w)}}const be=w.texture;(be.isData3DTexture||be.isDataArrayTexture||be.isCompressedArrayTexture)&&(ve=!0);const ze=Pe.get(w).__webglFramebuffer;w.isWebGLCubeRenderTarget?(Array.isArray(ze[k])?F=ze[k][V]:F=ze[k],ue=!0):w.samples>0&&b.useMultisampledRTT(w)===!1?F=Pe.get(w).__webglMultisampledFramebuffer:Array.isArray(ze)?F=ze[V]:F=ze,y.copy(w.viewport),T.copy(w.scissor),U=w.scissorTest}else y.copy(P).multiplyScalar(Y).floor(),T.copy(te).multiplyScalar(Y).floor(),U=ye;if(N.bindFramebuffer(D.FRAMEBUFFER,F)&&W&&N.drawBuffers(w,F),N.viewport(y),N.scissor(T),N.setScissorTest(U),ue){const he=Pe.get(w.texture);D.framebufferTexture2D(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,D.TEXTURE_CUBE_MAP_POSITIVE_X+k,he.__webglTexture,V)}else if(ve){const he=Pe.get(w.texture),be=k||0;D.framebufferTextureLayer(D.FRAMEBUFFER,D.COLOR_ATTACHMENT0,he.__webglTexture,V||0,be)}R=-1},this.readRenderTargetPixels=function(w,k,V,W,F,ue,ve){if(!(w&&w.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let pe=Pe.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&ve!==void 0&&(pe=pe[ve]),pe){N.bindFramebuffer(D.FRAMEBUFFER,pe);try{const he=w.texture,be=he.format,ze=he.type;if(!He.textureFormatReadable(be)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!He.textureTypeReadable(ze)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}k>=0&&k<=w.width-W&&V>=0&&V<=w.height-F&&D.readPixels(k,V,W,F,Ne.convert(be),Ne.convert(ze),ue)}finally{const he=M!==null?Pe.get(M).__webglFramebuffer:null;N.bindFramebuffer(D.FRAMEBUFFER,he)}}},this.readRenderTargetPixelsAsync=async function(w,k,V,W,F,ue,ve){if(!(w&&w.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let pe=Pe.get(w).__webglFramebuffer;if(w.isWebGLCubeRenderTarget&&ve!==void 0&&(pe=pe[ve]),pe){const he=w.texture,be=he.format,ze=he.type;if(!He.textureFormatReadable(be))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!He.textureTypeReadable(ze))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");if(k>=0&&k<=w.width-W&&V>=0&&V<=w.height-F){N.bindFramebuffer(D.FRAMEBUFFER,pe);const Re=D.createBuffer();D.bindBuffer(D.PIXEL_PACK_BUFFER,Re),D.bufferData(D.PIXEL_PACK_BUFFER,ue.byteLength,D.STREAM_READ),D.readPixels(k,V,W,F,Ne.convert(be),Ne.convert(ze),0);const lt=M!==null?Pe.get(M).__webglFramebuffer:null;N.bindFramebuffer(D.FRAMEBUFFER,lt);const at=D.fenceSync(D.SYNC_GPU_COMMANDS_COMPLETE,0);return D.flush(),await iA(D,at,4),D.bindBuffer(D.PIXEL_PACK_BUFFER,Re),D.getBufferSubData(D.PIXEL_PACK_BUFFER,0,ue),D.deleteBuffer(Re),D.deleteSync(at),ue}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")}},this.copyFramebufferToTexture=function(w,k=null,V=0){w.isTexture!==!0&&(uf("WebGLRenderer: copyFramebufferToTexture function signature has changed."),k=arguments[0]||null,w=arguments[1]);const W=Math.pow(2,-V),F=Math.floor(w.image.width*W),ue=Math.floor(w.image.height*W),ve=k!==null?k.x:0,pe=k!==null?k.y:0;b.setTexture2D(w,0),D.copyTexSubImage2D(D.TEXTURE_2D,V,0,0,ve,pe,F,ue),N.unbindTexture()},this.copyTextureToTexture=function(w,k,V=null,W=null,F=0){w.isTexture!==!0&&(uf("WebGLRenderer: copyTextureToTexture function signature has changed."),W=arguments[0]||null,w=arguments[1],k=arguments[2],F=arguments[3]||0,V=null);let ue,ve,pe,he,be,ze;V!==null?(ue=V.max.x-V.min.x,ve=V.max.y-V.min.y,pe=V.min.x,he=V.min.y):(ue=w.image.width,ve=w.image.height,pe=0,he=0),W!==null?(be=W.x,ze=W.y):(be=0,ze=0);const Re=Ne.convert(k.format),lt=Ne.convert(k.type);b.setTexture2D(k,0),D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,k.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,k.unpackAlignment);const at=D.getParameter(D.UNPACK_ROW_LENGTH),xt=D.getParameter(D.UNPACK_IMAGE_HEIGHT),ln=D.getParameter(D.UNPACK_SKIP_PIXELS),Je=D.getParameter(D.UNPACK_SKIP_ROWS),Ie=D.getParameter(D.UNPACK_SKIP_IMAGES),mn=w.isCompressedTexture?w.mipmaps[F]:w.image;D.pixelStorei(D.UNPACK_ROW_LENGTH,mn.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,mn.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,pe),D.pixelStorei(D.UNPACK_SKIP_ROWS,he),w.isDataTexture?D.texSubImage2D(D.TEXTURE_2D,F,be,ze,ue,ve,Re,lt,mn.data):w.isCompressedTexture?D.compressedTexSubImage2D(D.TEXTURE_2D,F,be,ze,mn.width,mn.height,Re,mn.data):D.texSubImage2D(D.TEXTURE_2D,F,be,ze,ue,ve,Re,lt,mn),D.pixelStorei(D.UNPACK_ROW_LENGTH,at),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,xt),D.pixelStorei(D.UNPACK_SKIP_PIXELS,ln),D.pixelStorei(D.UNPACK_SKIP_ROWS,Je),D.pixelStorei(D.UNPACK_SKIP_IMAGES,Ie),F===0&&k.generateMipmaps&&D.generateMipmap(D.TEXTURE_2D),N.unbindTexture()},this.copyTextureToTexture3D=function(w,k,V=null,W=null,F=0){w.isTexture!==!0&&(uf("WebGLRenderer: copyTextureToTexture3D function signature has changed."),V=arguments[0]||null,W=arguments[1]||null,w=arguments[2],k=arguments[3],F=arguments[4]||0);let ue,ve,pe,he,be,ze,Re,lt,at;const xt=w.isCompressedTexture?w.mipmaps[F]:w.image;V!==null?(ue=V.max.x-V.min.x,ve=V.max.y-V.min.y,pe=V.max.z-V.min.z,he=V.min.x,be=V.min.y,ze=V.min.z):(ue=xt.width,ve=xt.height,pe=xt.depth,he=0,be=0,ze=0),W!==null?(Re=W.x,lt=W.y,at=W.z):(Re=0,lt=0,at=0);const ln=Ne.convert(k.format),Je=Ne.convert(k.type);let Ie;if(k.isData3DTexture)b.setTexture3D(k,0),Ie=D.TEXTURE_3D;else if(k.isDataArrayTexture||k.isCompressedArrayTexture)b.setTexture2DArray(k,0),Ie=D.TEXTURE_2D_ARRAY;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}D.pixelStorei(D.UNPACK_FLIP_Y_WEBGL,k.flipY),D.pixelStorei(D.UNPACK_PREMULTIPLY_ALPHA_WEBGL,k.premultiplyAlpha),D.pixelStorei(D.UNPACK_ALIGNMENT,k.unpackAlignment);const mn=D.getParameter(D.UNPACK_ROW_LENGTH),dt=D.getParameter(D.UNPACK_IMAGE_HEIGHT),Yi=D.getParameter(D.UNPACK_SKIP_PIXELS),zo=D.getParameter(D.UNPACK_SKIP_ROWS),li=D.getParameter(D.UNPACK_SKIP_IMAGES);D.pixelStorei(D.UNPACK_ROW_LENGTH,xt.width),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,xt.height),D.pixelStorei(D.UNPACK_SKIP_PIXELS,he),D.pixelStorei(D.UNPACK_SKIP_ROWS,be),D.pixelStorei(D.UNPACK_SKIP_IMAGES,ze),w.isDataTexture||w.isData3DTexture?D.texSubImage3D(Ie,F,Re,lt,at,ue,ve,pe,ln,Je,xt.data):k.isCompressedArrayTexture?D.compressedTexSubImage3D(Ie,F,Re,lt,at,ue,ve,pe,ln,xt.data):D.texSubImage3D(Ie,F,Re,lt,at,ue,ve,pe,ln,Je,xt),D.pixelStorei(D.UNPACK_ROW_LENGTH,mn),D.pixelStorei(D.UNPACK_IMAGE_HEIGHT,dt),D.pixelStorei(D.UNPACK_SKIP_PIXELS,Yi),D.pixelStorei(D.UNPACK_SKIP_ROWS,zo),D.pixelStorei(D.UNPACK_SKIP_IMAGES,li),F===0&&k.generateMipmaps&&D.generateMipmap(Ie),N.unbindTexture()},this.initRenderTarget=function(w){Pe.get(w).__webglFramebuffer===void 0&&b.setupRenderTarget(w)},this.initTexture=function(w){w.isCubeTexture?b.setTextureCube(w,0):w.isData3DTexture?b.setTexture3D(w,0):w.isDataArrayTexture||w.isCompressedArrayTexture?b.setTexture2DArray(w,0):b.setTexture2D(w,0),N.unbindTexture()},this.resetState=function(){C=0,A=0,M=null,N.reset(),tt.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Or}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=e===og?"display-p3":"srgb",t.unpackColorSpace=pt.workingColorSpace===Ed?"display-p3":"srgb"}}class gb extends ti{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.backgroundRotation=new Yr,this.environmentIntensity=1,this.environmentRotation=new Yr,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,this.backgroundRotation.copy(e.backgroundRotation),this.environmentIntensity=e.environmentIntensity,this.environmentRotation.copy(e.environmentRotation),e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.object.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.object.backgroundIntensity=this.backgroundIntensity),t.object.backgroundRotation=this.backgroundRotation.toArray(),this.environmentIntensity!==1&&(t.object.environmentIntensity=this.environmentIntensity),t.object.environmentRotation=this.environmentRotation.toArray(),t}}class vb extends Vu{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new gt(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const Fv=new Kt,Um=new eM,bc=new Td,Dc=new q;class xb extends ti{constructor(e=new Zr,t=new vb){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=Array.isArray(e.material)?e.material.slice():e.material,this.geometry=e.geometry,this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,o=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),bc.copy(i.boundingSphere),bc.applyMatrix4(r),bc.radius+=s,e.ray.intersectsSphere(bc)===!1)return;Fv.copy(r).invert(),Um.copy(e.ray).applyMatrix4(Fv);const a=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=a*a,u=i.index,d=i.attributes.position;if(u!==null){const f=Math.max(0,o.start),p=Math.min(u.count,o.start+o.count);for(let _=f,g=p;_<g;_++){const m=u.getX(_);Dc.fromBufferAttribute(d,m),kv(Dc,m,l,r,e,t,this)}}else{const f=Math.max(0,o.start),p=Math.min(d.count,o.start+o.count);for(let _=f,g=p;_<g;_++)Dc.fromBufferAttribute(d,_),kv(Dc,_,l,r,e,t,this)}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,o=r.length;s<o;s++){const a=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[a]=s}}}}}function kv(n,e,t,i,r,s,o){const a=Um.distanceSqToPoint(n);if(a<t){const l=new q;Um.closestPointToPoint(n,l),l.applyMatrix4(i);const u=r.ray.origin.distanceTo(l);if(u<r.near||u>r.far)return;s.push({distance:u,distanceToRay:Math.sqrt(a),point:l,index:e,face:null,faceIndex:null,barycoord:null,object:o})}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:J_}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=J_);function Rr(n){if(n===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return n}function _M(n,e){n.prototype=Object.create(e.prototype),n.prototype.constructor=n,n.__proto__=e}/*!
 * GSAP 3.15.0
 * https://gsap.com
 *
 ...
 * Subject to the terms at https://gsap.com/standard-license
 * @author: Jack Doyle, jack@greensock.com
*/var gn,pf,gi,gs,vs,Na,dE,io,Oa,hE,kr,Zi,pE,mE=function(){return gn||typeof window<"u"&&(gn=window.gsap)&&gn.registerPlugin&&gn},_E=1,Ma=[],it=[],xr=[],Kl=Date.now,jm=function(e,t){return t},HD=function(){var e=Oa.core,t=e.bridge||{},i=e._scrollers,r=e._proxies;i.push.apply(i,it),r.push.apply(r,xr),it=i,xr=r,jm=function(o,a){return t[o](a)}},Ds=function(e,t){return~xr.indexOf(e)&&xr[xr.indexOf(e)+1][t]},Zl=function(e){return!!~hE.indexOf(e)},Un=function(e,t,i,r,s){return e.addEventListener(t,i,{passive:r!==!1,capture:!!s})},In=function(e,t,i,r){return e.removeEventListener(t,i,!!r)},Ic="scrollLeft",Uc="scrollTop",Km=function(){return kr&&kr.isPressed||it.cache++},nd=function(e,t){var i=function r(s){if(s||s===0){_E&&(gi.history.scrollRestoration="manual");var o=kr&&kr.isPressed;s=r.v=Math.round(s)||(kr&&kr.iOS?1:0),e(s),r.cacheID=it.cache,o&&jm("ss",s)}else(t||it.cache!==r.cacheID||jm("ref"))&&(r.cacheID=it.cache,r.v=e());return r.v+r.offset};return i.offset=0,e&&i},Bn={s:Ic,p:"left",p2:"Left",os:"right",os2:"Right",d:"width",d2:"Width",a:"x",sc:nd(function(n){return arguments.length?gi.scrollTo(n,rn.sc()):gi.pageXOffset||gs[Ic]||vs[Ic]||Na[Ic]||0})},rn={s:Uc,p:"top",p2:"Top",os:"bottom",os2:"Bottom",d:"height",d2:"Height",a:"y",op:Bn,sc:nd(function(n){return arguments.length?gi.scrollTo(Bn.sc(),n):gi.pageYOffset||gs[Uc]||vs[Uc]||Na[Uc]||0})},Xn=function(e,t){return(t&&t._ctx&&t._ctx.selector||gn.utils.toArray)(e)[0]||(typeof e=="string"&&gn.config().nullTargetWarn!==!1?console.warn("Element not found:",e):null)},VD=function(e,t){for(var i=t.length;i--;)if(t[i]===e||t[i].contains(e))return!0;return!1},ks=function(e,t){var i=t.s,r=t.sc;Zl(e)&&(e=gs.scrollingElement||vs);var s=it.indexOf(e),o=r===rn.sc?1:2;!~s&&(s=it.push(e)-1),it[s+o]||Un(e,"scroll",Km);var a=it[s+o],l=a||(it[s+o]=nd(Ds(e,i),!0)||(Zl(e)?r:nd(function(u){return arguments.length?e[i]=u:e[i]})));return l.target=e,a||(l.smooth=gn.getProperty(e,"scrollBehavior")==="smooth"),l},Zm=function(e,t,i){var r=e,s=e,o=Kl(),a=o,l=t||50,u=Math.max(500,l*3),c=function(_,g){var m=Kl();g||m-o>l?(s=r,r=_,a=o,o=m):i?r+=_:r=s+(_-s)/(m-a)*(o-a)},d=function(){s=r=i?0:r,a=o=0},f=function(_){var g=a,m=s,h=Kl();return(_||_===0)&&_!==r&&c(_),o===a||h-a>u?0:(r+(i?m:-m))/((i?h:o)-g)*1e3};return{update:c,reset:d,getVelocity:f}},Tl=function(e,t){return t&&!e._gsapAllow&&e.cancelable!==!1&&e.preventDefault(),e.changedTouches?e.changedTouches[0]:e},ix=function(e){var t=Math.max.apply(Math,e),i=Math.min.apply(Math,e);return Math.abs(t)>=Math.abs(i)?t:i},gE=function(){Oa=gn.core.globals().ScrollTrigger,Oa&&Oa.core&&HD()},vE=function(e){return gn=e||mE(),!pf&&gn&&typeof document<"u"&&document.body&&(gi=window,gs=document,vs=gs.documentElement,Na=gs.body,hE=[gi,gs,vs,Na],gn.utils.clamp,pE=gn.core.context||function(){},io="onpointerenter"in Na?"pointer":"mouse",dE=jt.isTouch=gi.matchMedia&&gi.matchMedia("(hover: none), (pointer: coarse)").matches?1:"ontouchstart"in gi||navigator.maxTouchPoints>0||navigator.msMaxTouchPoints>0?2:0,Zi=jt.eventTypes=("ontouchstart"in vs?"touchstart,touchmove,touchcancel,touchend":"onpointerdown"in vs?"pointerdown,pointermove,pointercancel,pointerup":"mousedown,mousemove,mouseup,mouseup").split(","),setTimeout(function(){return _E=0},500),pf=1),Oa||gE(),pf};Bn.op=rn;it.cache=0;var jt=function(){function n(t){this.init(t)}var e=n.prototype;return e.init=function(i){pf||vE(gn)||console.warn("Please gsap.registerPlugin(Observer)"),Oa||gE();var r=i.tolerance,s=i.dragMinimum,o=i.type,a=i.target,l=i.lineHeight,u=i.debounce,c=i.preventDefault,d=i.onStop,f=i.onStopDelay,p=i.ignore,_=i.wheelSpeed,g=i.event,m=i.onDragStart,h=i.onDragEnd,v=i.onDrag,x=i.onPress,S=i.onRelease,C=i.onRight,A=i.onLeft,M=i.onUp,R=i.onDown,I=i.onChangeX,y=i.onChangeY,T=i.onChange,U=i.onToggleX,z=i.onToggleY,X=i.onHover,$=i.onHoverEnd,B=i.onMove,Y=i.ignoreCheck,L=i.isNormalizer,j=i.onGestureStart,P=i.onGestureEnd,te=i.onWheel,ye=i.onEnable,Be=i.onDisable,H=i.onClick,Q=i.scrollSpeed,re=i.capture,le=i.allowClicks,Ae=i.lockAxis,Te=i.onLockAxis;this.target=a=Xn(a)||vs,this.vars=i,p&&(p=gn.utils.toArray(p)),r=r||1e-9,s=s||0,_=_||1,Q=Q||1,o=o||"wheel,touch,pointer",u=u!==!1,l||(l=parseFloat(gi.getComputedStyle(Na).lineHeight)||22);var qe,Ge,Oe,D,rt,Fe,He,N=this,We=0,Pe=0,b=i.passive||!c&&i.passive!==!1,E=ks(a,Bn),G=ks(a,rn),J=E(),ie=G(),Z=~o.indexOf("touch")&&!~o.indexOf("pointer")&&Zi[0]==="pointerdown",Me=Zl(a),oe=a.ownerDocument||gs,fe=[0,0,0],Ve=[0,0,0],se=0,xe=function(){return se=Kl()},Se=function(Ce,ct){return(N.event=Ce)&&p&&VD(Ce.target,p)||ct&&Z&&Ce.pointerType!=="touch"||Y&&Y(Ce,ct)},Ue=function(){N._vx.reset(),N._vy.reset(),Ge.pause(),d&&d(N)},me=function(){var Ce=N.deltaX=ix(fe),ct=N.deltaY=ix(Ve),_e=Math.abs(Ce)>=r,ke=Math.abs(ct)>=r;T&&(_e||ke)&&T(N,Ce,ct,fe,Ve),_e&&(C&&N.deltaX>0&&C(N),A&&N.deltaX<0&&A(N),I&&I(N),U&&N.deltaX<0!=We<0&&U(N),We=N.deltaX,fe[0]=fe[1]=fe[2]=0),ke&&(R&&N.deltaY>0&&R(N),M&&N.deltaY<0&&M(N),y&&y(N),z&&N.deltaY<0!=Pe<0&&z(N),Pe=N.deltaY,Ve[0]=Ve[1]=Ve[2]=0),(D||Oe)&&(B&&B(N),Oe&&(m&&Oe===1&&m(N),v&&v(N),Oe=0),D=!1),Fe&&!(Fe=!1)&&Te&&Te(N),rt&&(te(N),rt=!1),qe=0},Ye=function(Ce,ct,_e){fe[_e]+=Ce,Ve[_e]+=ct,N._vx.update(Ce),N._vy.update(ct),u?qe||(qe=requestAnimationFrame(me)):me()},Ne=function(Ce,ct){Ae&&!He&&(N.axis=He=Math.abs(Ce)>Math.abs(ct)?"x":"y",Fe=!0),He!=="y"&&(fe[2]+=Ce,N._vx.update(Ce,!0)),He!=="x"&&(Ve[2]+=ct,N._vy.update(ct,!0)),u?qe||(qe=requestAnimationFrame(me)):me()},tt=function(Ce){if(!Se(Ce,1)){Ce=Tl(Ce,c);var ct=Ce.clientX,_e=Ce.clientY,ke=ct-N.x,Le=_e-N.y,Xe=N.isDragging;N.x=ct,N.y=_e,(Xe||(ke||Le)&&(Math.abs(N.startX-ct)>=s||Math.abs(N.startY-_e)>=s))&&(Oe||(Oe=Xe?2:1),Xe||(N.isDragging=!0),Ne(ke,Le))}},O=N.onPress=function(De){Se(De,1)||De&&De.button||(N.axis=He=null,Ge.pause(),N.isPressed=!0,De=Tl(De),We=Pe=0,N.startX=N.x=De.clientX,N.startY=N.y=De.clientY,N._vx.reset(),N._vy.reset(),Un(L?a:oe,Zi[1],tt,b,!0),N.deltaX=N.deltaY=0,x&&x(N))},ne=N.onRelease=function(De){if(!Se(De,1)){In(L?a:oe,Zi[1],tt,!0);var Ce=!isNaN(N.y-N.startY),ct=N.isDragging,_e=ct&&(Math.abs(N.x-N.startX)>3||Math.abs(N.y-N.startY)>3),ke=Tl(De);!_e&&Ce&&(N._vx.reset(),N._vy.reset(),c&&le&&gn.delayedCall(.08,function(){if(Kl()-se>300&&!De.defaultPrevented){if(De.target.click)De.target.click();else if(oe.createEvent){var Le=oe.createEvent("MouseEvents");Le.initMouseEvent("click",!0,!0,gi,1,ke.screenX,ke.screenY,ke.clientX,ke.clientY,!1,!1,!1,!1,0,null),De.target.dispatchEvent(Le)}}})),N.isDragging=N.isGesturing=N.isPressed=!1,d&&ct&&!L&&Ge.restart(!0),Oe&&me(),h&&ct&&h(N),S&&S(N,_e)}},K=function(Ce){return Ce.touches&&Ce.touches.length>1&&(N.isGesturing=!0)&&j(Ce,N.isDragging)},ee=function(){return(N.isGesturing=!1)||P(N)},ce=function(Ce){if(!Se(Ce)){var ct=E(),_e=G();Ye((ct-J)*Q,(_e-ie)*Q,1),J=ct,ie=_e,d&&Ge.restart(!0)}},de=function(Ce){if(!Se(Ce)){Ce=Tl(Ce,c),te&&(rt=!0);var ct=(Ce.deltaMode===1?l:Ce.deltaMode===2?gi.innerHeight:1)*_;Ye(Ce.deltaX*ct,Ce.deltaY*ct,0),d&&!L&&Ge.restart(!0)}},$e=function(Ce){if(!Se(Ce)){var ct=Ce.clientX,_e=Ce.clientY,ke=ct-N.x,Le=_e-N.y;N.x=ct,N.y=_e,D=!0,d&&Ge.restart(!0),(ke||Le)&&Ne(ke,Le)}},yt=function(Ce){N.event=Ce,X(N)},Dt=function(Ce){N.event=Ce,$(N)},st=function(Ce){return Se(Ce)||Tl(Ce,c)&&H(N)};Ge=N._dc=gn.delayedCall(f||.25,Ue).pause(),N.deltaX=N.deltaY=0,N._vx=Zm(0,50,!0),N._vy=Zm(0,50,!0),N.scrollX=E,N.scrollY=G,N.isDragging=N.isGesturing=N.isPressed=!1,pE(this),N.enable=function(De){return N.isEnabled||(Un(Me?oe:a,"scroll",Km),o.indexOf("scroll")>=0&&Un(Me?oe:a,"scroll",ce,b,re),o.indexOf("wheel")>=0&&Un(a,"wheel",de,b,re),(o.indexOf("touch")>=0&&dE||o.indexOf("pointer")>=0)&&(Un(a,Zi[0],O,b,re),Un(oe,Zi[2],ne),Un(oe,Zi[3],ne),le&&Un(a,"click",xe,!0,!0),H&&Un(a,"click",st),j&&Un(oe,"gesturestart",K),P&&Un(oe,"gestureend",ee),X&&Un(a,io+"enter",yt),$&&Un(a,io+"leave",Dt),B&&Un(a,io+"move",$e)),N.isEnabled=!0,N.isDragging=N.isGesturing=N.isPressed=D=Oe=!1,N._vx.reset(),N._vy.reset(),J=E(),ie=G(),De&&De.type&&O(De),ye&&ye(N)),N},N.disable=function(){N.isEnabled&&(Ma.filter(function(De){return De!==N&&Zl(De.target)}).length||In(Me?oe:a,"scroll",Km),N.isPressed&&(N._vx.reset(),N._vy.reset(),In(L?a:oe,Zi[1],tt,!0)),In(Me?oe:a,"scroll",ce,re),In(a,"wheel",de,re),In(a,Zi[0],O,re),In(oe,Zi[2],ne),In(oe,Zi[3],ne),In(a,"click",xe,!0),In(a,"click",st),In(oe,"gesturestart",K),In(oe,"gestureend",ee),In(a,io+"enter",yt),In(a,io+"leave",Dt),In(a,io+"move",$e),N.isEnabled=N.isPressed=N.isDragging=!1,Be&&Be(N))},N.kill=N.revert=function(){N.disable();var De=Ma.indexOf(N);De>=0&&Ma.splice(De,1),kr===N&&(kr=0)},Ma.push(N),L&&Zl(a)&&(kr=N),N.enable(g)},BD(n,[{key:"velocityX",get:function(){return this._vx.getVelocity()}},{key:"velocityY",get:function(){return this._vy.getVelocity()}}]),n}();jt.version="3.15.0";jt.create=function(n){return new jt(n)};jt.register=vE;jt.getAll=function(){return Ma.slice()};jt.getById=function(n){return Ma.filter(function(e){return e.vars.id===n})[0]};mE()&&gn.registerPlugin(jt);/*!
...
`,Zh={mobile:{targetCount:1e4,mouseRadius:.5,mouseStrength:.007},tablet:{targetCount:22e3,mouseRadius:.4,mouseStrength:.01},desktop:{targetCount:55e3,mouseRadius:.35,mouseStrength:.014}},aL=2.8,Qh=.18,lL=2.2,Sx=.45,Mx=.03,uL=.028,cL=.88,Ex=.006,Tx=.5;function fL(){const n=Li.useRef(null),e=Li.useRef(null);return Li.useEffect(()=>{const t=n.current;if(!t||window.matchMedia("(prefers-reduced-motion: reduce)").matches)return;const r=window.innerWidth,s=window.innerHeight,o=r<=768?Zh.mobile:r<=1024?Zh.tablet:Zh.desktop,a=o.mouseRadius,l=o.mouseStrength,u=a*a,c=document.createElement("canvas");t.appendChild(c);const d=new _b({canvas:c,antialias:!1,alpha:!1,powerPreference:"high-performance"}),f=Math.min(window.devicePixelRatio,2);d.setPixelRatio(f),d.setSize(r,s),d.setClearColor(0,1);const p=new gb,_=new Ni(70,r/s,.001,100);_.position.set(0,-.04,Qh);let g=null,m=null,h=null,v=0,x=null,S=null,C=null,A=null,M=null,R=null,I=0,y=0,T=0,U=0,z=!1,X=0,$=performance.now(),B=!1;const Y=new Image;Y.onload=()=>{if(B)return;const H=rL({img:Y,targetCount:o.targetCount,imageScale:aL});v=H.count,x=H.origX,S=H.origY,C=H.depths,A=new Float32Array(v*3),M=new Float32Array(v),R=new Float32Array(v);for(let re=0;re<v;re++)A[re*3]=x[re],A[re*3+1]=S[re],A[re*3+2]=C[re]*Sx;m=new Zr;const Q=new Mi(A,3);Q.setUsage(eA),m.setAttribute("position",Q),m.setAttribute("aColor",new Mi(H.colors,3)),m.setAttribute("aSize",new Mi(H.sizes,1)),h=new qr({vertexShader:sL,fragmentShader:oL,uniforms:{uPixelRatio:{value:f},uOpacity:{value:.65}},transparent:!0,blending:Yp,depthWrite:!1,depthTest:!1}),g=new xb(m,h),p.add(g),je.create({trigger:t,start:"top top",end:"+=2400",pin:!0,pinSpacing:!0,onUpdate(re){I=re.progress}}),$=performance.now(),e.current=requestAnimationFrame(L)},Y.onerror=()=>{console.warn("[ParticleHero] Could not load /deepak-hero-particles.png — place the image in the /public folder and reload.")},Y.src="/deepak-hero-particles.png";function L(){e.current=requestAnimationFrame(L);const H=performance.now(),Q=Math.min((H-$)/16.667,4);$=H,X+=Q*.016,y+=(I-y)*.055;const re=y,le=Qh+re*(lL-Qh),Ae=(1-re)*-.04;_.position.z+=(le-_.position.z)*.07*Q,_.position.y+=(Ae-_.position.y)*.07*Q,g&&(g.rotation.x+=((1-re)*.055-g.rotation.x)*.06*Q);const Te=Math.max(0,1-re*1.3)*Sx;if(h&&(h.uniforms.uOpacity.value+=(.62+re*.38-h.uniforms.uOpacity.value)*.05*Q),!v||!A||!m){d.render(p,_);return}const qe=_.fov*Math.PI/180,Ge=_.position.z,Oe=2*Math.tan(qe/2)*Ge,D=Oe*_.aspect,rt=T*(D*.5),Fe=U*(Oe*.5),He=Math.pow(cL,Q);for(let N=0;N<v;N++){const We=N*3,Pe=A[We],b=A[We+1],E=A[We+2],G=x[N],J=S[N],ie=C[N]*Te,Z=C[N]*6.2832,Me=Math.sin(X*Tx+Z)*Ex,oe=Math.cos(X*Tx*.73+Z*1.31)*Ex;let fe=0,Ve=0;if(z){const Ue=Pe-rt,me=b-Fe,Ye=Ue*Ue+me*me;if(Ye<u&&Ye>1e-8){const Ne=Math.sqrt(Ye),tt=(1-Ne/a)*l*Q;fe=Ue/Ne*tt,Ve=me/Ne*tt}}const se=(G+Me-Pe)*Mx*Q,xe=(J+oe-b)*Mx*Q,Se=(ie-E)*uL*Q;M[N]=(M[N]+se+fe)*He,R[N]=(R[N]+xe+Ve)*He,A[We]=Pe+M[N],A[We+1]=b+R[N],A[We+2]=E+Se}m.attributes.position.needsUpdate=!0,d.render(p,_)}const j=H=>{T=H.clientX/window.innerWidth*2-1,U=-(H.clientY/window.innerHeight)*2+1,z=!0},P=()=>{z=!1},te=H=>{H.touches.length&&(T=H.touches[0].clientX/window.innerWidth*2-1,U=-(H.touches[0].clientY/window.innerHeight)*2+1,z=!0)},ye=()=>{z=!1},Be=()=>{const H=window.innerWidth,Q=window.innerHeight;_.aspect=H/Q,_.updateProjectionMatrix(),d.setSize(H,Q),h&&(h.uniforms.uPixelRatio.value=d.getPixelRatio())};return window.addEventListener("mousemove",j,{passive:!0}),window.addEventListener("mouseleave",P),window.addEventListener("touchmove",te,{passive:!0}),window.addEventListener("touchend",ye,{passive:!0}),window.addEventListener("resize",Be),()=>{B=!0,cancelAnimationFrame(e.current),window.removeEventListener("mousemove",j),window.removeEventListener("mouseleave",P),window.removeEventListener("touchmove",te),window.removeEventListener("touchend",ye),window.removeEventListener("resize",Be),je.getAll().forEach(H=>H.kill()),m==null||m.dispose(),h==null||h.dispose(),d.dispose(),c.parentNode&&c.parentNode.removeChild(c)}},[]),An.jsx("div",{className:"particle-hero",ref:n,children:An.jsx("noscript",{children:An.jsx("img",{src:"/deepak-hero-particles.png",alt:"Deepak Parikh at 60",className:"particle-fallback"})})})}po.registerPlugin(je);function dL(){const n=Li.useRef(null),e=Li.useRef(null),t=Li.useRef(null),i=Li.useRef(null),r=Li.useRef(null);return Li.useEffect(()=>{const s=n.current,o=e.current,a=t.current,l=i.current,u=r.current;if(!s||!o||!a||!l||!u)return;po.set(o,{backgroundColor:"#07070f"}),po.set(a,{opacity:0,scale:.72}),po.set([l,u],{opacity:0,y:32,filter:"blur(10px)"});const c=po.timeline();c.to({},{duration:.3},0),c.fromTo(o,{backgroundColor:"#07070f"},{backgroundColor:"#F2E6D0",duration:.38,ease:"power1.inOut"},.3),c.fromTo(a,{opacity:0,scale:.8},{opacity:1,scale:1,duration:.27,ease:"power2.out"},.45),c.fromTo(l,{opacity:0,y:32,filter:"blur(10px)"},{opacity:1,y:0,filter:"blur(0px)",duration:.13,ease:"power3.out"},.65),c.fromTo(u,{opacity:0,y:32,filter:"blur(10px)"},{opacity:1,y:0,filter:"blur(0px)",duration:.12,ease:"power3.out"},.78),c.to({},{duration:.1},.9);const d=je.create({trigger:s,start:"top top",end:"+=2400",pin:!0,pinSpacing:!0,scrub:1.8,animation:c});return()=>{d.kill(),c.kill()}},[]),An.jsxs("section",{className:"timeless-section",ref:n,children:[An.jsx("div",{className:"timeless-bg",ref:e}),An.jsx("div",{className:"timeless-grain","aria-hidden":"true"}),An.jsx("div",{className:"timeless-glow",ref:t,"aria-hidden":"true"}),An.jsx("div",{className:"timeless-quote-wrap",children:An.jsxs("h2",{className:"timeless-quote",children:[An.jsx("span",{ref:i,children:"The deepest roots are never seen,"}),An.jsx("span",{ref:r,children:"but everyone remembers the shade."})]})})]})}function hL(){return An.jsxs("main",{children:[An.jsx(fL,{}),An.jsx(dL,{})]})}Jh.createRoot(document.getElementById("root")).render(An.jsx(e1.StrictMode,{children:An.jsx(hL,{})}));
